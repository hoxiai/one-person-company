...
import { ar as useAppConfig, aB as useComponentUI, aD as tv, ax as _sfc_main$A, b as _sfc_main$E } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.title || !!slots.title) {
        _push(`<p class="${ssrRenderClass(ui.value.title({ class: (_d = unref(uiProp)) == null ? void 0 : _d.title }))}">`);
      ...
      if (!!slots.default) {
        _push(`<div class="${ssrRenderClass(ui.value.description({ class: (_e = unref(uiProp)) == null ? void 0 : _e.description }))}">`);
