import { aM as useLocaleRouter, a as __nuxt_component_3$1, b as _sfc_main$E } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative overflow-hidden rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-gradient-to-br from-blue-50/30 via-white to-amber-50/20 dark:from-slate-900/90 dark:via-slate-900/60 dark:to-slate-950 p-4 sm:p-6 md:p-8 shadow-xs" }, _attrs))}><div class="pointer-events-none absolute -right-16 -top-16 h-64 w-64 rounded-full bg-blue-500/10 dark:bg-blue-500/15 blur-3xl"></div><div class="pointer-events-none absolute -left-16 -bottom-16 h-64 w-64 rounded-full bg-amber-500/10 dark:bg-amber-500/15 blur-3xl"></div><div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 md:gap-8"><div class="max-w-xl space-y-3 sm:space-y-4"><div class="flex flex-wrap items-center gap-2"><span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 border border-amber-200/70 dark:border-amber-800/60 shadow-2xs"><span class="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse"></span><span>\u7B2C\u4E00\u5E55 \xB7 \u8BA4\u77E5\u4F53\u68C0</span></span></div><h2 class="text-xl md:text-2xl font-bold tracking-tight text-slate-900 dark:text-white leading-snug"> \u4E00\u4EBA\u6210\u519B\uFF0C\u4F60\u8FD8\u5DEE\u54EA\u4E00\u5757\uFF1F </h2><p class="text-xs md:text-sm text-slate-600 dark:text-slate-300 leading-relaxed"> 12 \u9053\u5B9E\u6218\u60C5\u5883\u9898\uFF0C\u6DF1\u5EA6\u8BCA\u65AD\u5168\u6808\u4EA4\u4ED8\u3001\u5546\u4E1A\u9A8C\u8BC1\u4E0E\u5FC3\u667A\u77ED\u677F\u3002 </p><div class="flex flex-wrap items-center gap-1.5 sm:gap-2 pt-1 text-xs"><span class="text-slate-400 dark:text-slate-500 font-medium text-[11px] sm:text-xs">\u4E13\u5C5E\u9898\u5E93\uFF1A</span><span class="inline-flex items-center gap-1 rounded-md bg-white/80 dark:bg-slate-800 px-2 py-0.5 sm:py-1 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700 shadow-2xs font-mono text-[10px] sm:text-[11px]"> \u{1F4BB} \u5DE5\u7A0B\u5E08 </span><span class="inline-flex items-center gap-1 rounded-md bg-white/80 dark:bg-slate-800 px-2 py-0.5 sm:py-1 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700 shadow-2xs font-mono text-[10px] sm:text-[11px]"> \u{1F3AF} \u4EA7\u54C1\u7ECF\u7406 </span><span class="inline-flex items-center gap-1 rounded-md bg-white/80 dark:bg-slate-800 px-2 py-0.5 sm:py-1 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700 shadow-2xs font-mono text-[10px] sm:text-[11px]"> \u{1F3A8} \u8BBE\u8BA1\u5E08 </span><span class="inline-flex items-center gap-1 rounded-md bg-white/80 dark:bg-slate-800 px-2 py-0.5 sm:py-1 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700 shadow-2xs font-mono text-[10px] sm:text-[11px]"> \u{1F4C8} \u8FD0\u8425\u589E\u957F </span></div><div class="pt-2 flex flex-wrap items-center gap-2.5 sm:gap-3">`);
