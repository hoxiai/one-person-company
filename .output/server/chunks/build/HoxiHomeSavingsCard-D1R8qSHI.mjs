import { aM as useLocaleRouter, z as useFetch, b as _sfc_main$G, a as __nuxt_component_3$1 } from './server.mjs';
...
import { u as useHoxiModels, s as sortModels, a as formatPrice, f as formatScore } from './useHoxiModels-BUR4ZXwz.mjs';
  ...
  setup(__props) {
    ...
    const topCodingModels = computed(() => {
      const codingCapable = models.value.filter(
        (model) => {
          var _a;
          return ((_a = model.scenes) == null ? void 0 : _a.includes("\u5199\u4EE3\u7801")) || model.scores.overall !== void 0 && model.scores.overall >= 45;
        }
      );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span><h2 class="text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white"> \u7B97\u529B\u964D\u672C\u5BF9\u6BD4 </h2></div><p class="mt-1 text-xs text-slate-500 dark:text-slate-400"> \u6A21\u578B\u5E95\u4EF7\u3001\u56FD\u5185\u4E13\u7EBF\u4E0E IDE \u5957\u9910\u771F\u5B9E\u8D26\u672C\u3002 </p></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span${_scopeId}>\u67E5\u770B\u5B8C\u6574\u65B9\u6848</span>`);
      ...
      _push(`</div></div><div class="p-6 md:p-8"><div class="flex items-center justify-between gap-3 mb-4"><div class="text-xs font-medium text-slate-400 dark:text-slate-500 font-mono"> \u5B9E\u6D4B\u6570\u636E\u4E00\u89C8 </div><div class="inline-flex rounded-xl bg-slate-100 dark:bg-slate-800 p-1 text-xs"><!--[-->`);
...
const __nuxt_component_5 = Object.assign(_sfc_main, { __name: "HoxiHomeSavingsCard" });
