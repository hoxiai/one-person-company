import { aM as useLocaleRouter, y as useFetch, a as __nuxt_component_3$1, b as _sfc_main$E } from './server.mjs';
...
import { u as useHoxiModels, s as sortModels, a as formatPrice, f as formatScore } from './useHoxiModels-CB4dunlj.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="mt-6 grid gap-4 lg:grid-cols-2"><div class="rounded-xl border border-slate-200/70 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 p-3.5 sm:p-4 space-y-2.5"><div class="text-xs font-bold text-slate-900 dark:text-white flex items-center gap-1.5"><span>\u{1F4A1}</span><span>\u7AD9\u957F\u5B9E\u64CD\u9EC4\u91D1\u642D\u914D</span></div><div class="space-y-2 text-xs"><div class="flex items-center justify-between p-2 rounded-lg bg-slate-50 dark:bg-slate-800/60"><div class="flex items-center gap-2"><span class="rounded bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300 px-1.5 py-0.5 text-[10px] font-semibold shrink-0">\u65E5\u5E38 70%</span><strong class="text-slate-800 dark:text-slate-100 font-mono text-xs sm:text-sm">Gemini 3.7 Flash</strong></div><span class="text-[10px] sm:text-[11px] text-slate-500 dark:text-slate-400">\u6781\u901F \xB7 \xA50.7/M</span></div><div class="flex items-center justify-between p-2 rounded-lg bg-slate-50 dark:bg-slate-800/60"><div class="flex items-center gap-2"><span class="rounded bg-purple-100 dark:bg-purple-950 text-purple-700 dark:text-purple-300 px-1.5 py-0.5 text-[10px] font-semibold shrink-0">\u653B\u575A 20%</span><strong class="text-slate-800 dark:text-slate-100 font-mono text-xs sm:text-sm">Claude 3.7 / Code</strong></div><span class="text-[10px] sm:text-[11px] text-slate-500 dark:text-slate-400">\u6DF1\u5EA6\u91CD\u6784 \xB7 \u6309\u91CF</span></div><div class="flex items-center justify-between p-2 rounded-lg bg-slate-50 dark:bg-slate-800/60"><div class="flex items-center gap-2"><span class="rounded bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 px-1.5 py-0.5 text-[10px] font-semibold shrink-0">\u9A8C\u8BC1 10%</span><strong class="text-slate-800 dark:text-slate-100 font-mono text-xs sm:text-sm">Grok 3 / Codex</strong></div><span class="text-[10px] sm:text-[11px] text-slate-500 dark:text-slate-400">\u4EA4\u53C9\u5BF9\u6BD4</span></div></div></div><div class="rounded-xl border border-emerald-200/60 dark:border-emerald-900/50 bg-emerald-50/30 dark:bg-emerald-950/20 p-3.5 sm:p-4 flex flex-col justify-between"><div><div class="flex items-center justify-between"><span class="text-xs font-bold text-slate-900 dark:text-white flex items-center gap-1.5">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "ph:receipt-bold",
        class: "w-4 h-4 text-emerald-600 dark:text-emerald-400"
      }, null, _parent));
      _push(`<span>\u6708\u5EA6\u7B97\u529B\u8D26\u672C\u5BF9\u6BD4</span></span><span class="text-[10px] font-semibold text-emerald-700 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-900/60 px-2 py-0.5 rounded-full"> \u7ACB\u964D 88% </span></div><div class="mt-3 grid grid-cols-2 gap-2 sm:gap-3 text-center"><div class="rounded-lg bg-white/80 dark:bg-slate-900/70 p-2 sm:p-2.5 border border-slate-200/60 dark:border-slate-800"><div class="text-[10px] sm:text-[11px] text-slate-400">\u5B98\u65B9\u5168\u5957\u6708\u8BA2\u9605</div><div class="text-base sm:text-lg font-bold text-slate-600 dark:text-slate-400 font-mono line-through">\xA51,500/\u6708</div><div class="text-[10px] text-slate-400 mt-0.5 leading-tight">\u6D77\u5916\u5361\u95E8\u69DB \xB7 \u95F2\u7F6E\u6263\u6B3E</div></div><div class="rounded-lg bg-white/90 dark:bg-slate-900/90 p-2 sm:p-2.5 border border-emerald-300 dark:border-emerald-800 shadow-2xs"><div class="text-[10px] sm:text-[11px] text-emerald-700 dark:text-emerald-400 font-semibold">\u4E00\u4EBA\u516C\u53F8\u4E13\u7EBF\u65B9\u6848</div><div class="text-base sm:text-lg font-bold text-emerald-600 dark:text-emerald-400 font-mono">\xA568/\u6708 \u8D77</div><div class="text-[10px] text-emerald-600 dark:text-emerald-400 mt-0.5 leading-tight">\u56FD\u5185\u76F4\u8FDE \xB7 \u989D\u5EA6\u4E0D\u8FC7\u671F</div></div></div></div><div class="mt-3 pt-2 border-t border-emerald-200/40 dark:border-emerald-900/40 text-center text-xs text-emerald-800 dark:text-emerald-300 font-medium"> \u6BCF\u5E74\u7701\u4E0B\u7EA6 <strong>\xA517,000+</strong> \u73B0\u91D1\u8DD1\u9053 </div></div></div></div><div class="p-6 md:p-8"><div class="flex items-center justify-between gap-3 mb-4"><div class="text-xs font-bold text-slate-500 uppercase tracking-wider"> \u6DF1\u5165\u67E5\u9A8C\u6570\u636E\u660E\u7EC6 </div><div class="inline-flex rounded-xl bg-slate-100 dark:bg-slate-800 p-1 text-xs"><!--[-->`);
      ...
      if (activeDataTab.value === "gateways") {
        ...
        ssrRenderList(topGateways.value, (gw) => {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            class: "font-bold text-slate-900 dark:text-slate-100 hover:text-blue-600 flex items-center gap-1.5 text-xs"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
          ...
          _push(`<span class="text-xs font-bold text-slate-900 dark:text-white font-mono">${ssrInterpolate(gw.priceLabel)}</span></div><div class="mt-2 flex items-center justify-between text-[11px] text-slate-400"><span>\u5EF6\u8FDF <strong class="text-emerald-600 font-mono">${ssrInterpolate(gw.latencyMs)}ms</strong></span><span>\u5728\u7EBF\u7387 <strong class="text-emerald-600 font-mono">${ssrInterpolate(gw.uptime)}</strong></span>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: unref(localePath)(`/gateways/${gw.id}`),
        ...
        ssrRenderList(topCodingModels.value, (model) => {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            class: "font-bold text-slate-900 dark:text-white hover:text-blue-600 flex items-center gap-1.5 text-xs"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
