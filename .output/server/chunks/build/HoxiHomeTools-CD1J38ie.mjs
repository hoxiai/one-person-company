...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span><h2 class="text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white"> \u5168\u6808\u5DE5\u5177\u7BB1 </h2></div></div>`);
...
const __nuxt_component_6 = Object.assign(_sfc_main, { __name: "HoxiHomeTools" });
