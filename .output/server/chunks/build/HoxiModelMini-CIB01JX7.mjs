...
import { a as formatPrice, f as formatScore } from './useHoxiModels-CB4dunlj.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        class: "group block border-t border-slate-100 pt-4"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<span class="text-sm font-medium leading-6 text-slate-800 transition-colors group-hover:text-blue-500"${_scopeId}>${ssrInterpolate(__props.model.name)}</span>`);
            if (__props.model.isFree) {
              _push2(`<span class="rounded-full bg-emerald-50 px-1.5 py-0.5 text-[10px] font-medium leading-none text-emerald-700"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.model.tags.free"))}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</span><span class="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-slate-500"${_scopeId}><span${_scopeId}>${ssrInterpolate(((_a = __props.model.vendorInfo) == null ? void 0 : _a.nameZh) || __props.model.vendor)}</span><span class="text-slate-300" aria-hidden="true"${_scopeId}>\xB7</span><span class="tabular-nums"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.model.blendedShort"))} \xA5${ssrInterpolate(unref(formatPrice)(__props.model.blendedPrice))}</span>`);
            ...
            return [
              createVNode("span", { class: "flex items-center gap-1.5" }, [
                ...
                createVNode("span", { class: "text-sm font-medium leading-6 text-slate-800 transition-colors group-hover:text-blue-500" }, toDisplayString(__props.model.name), 1),
                __props.model.isFree ? (openBlock(), createBlock("span", {
                  key: 0,
                  class: "rounded-full bg-emerald-50 px-1.5 py-0.5 text-[10px] font-medium leading-none text-emerald-700"
                }, toDisplayString(_ctx.$t("hoxi.model.tags.free")), 1)) : createCommentVNode("", true)
              ]),
              createVNode("span", { class: "mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-slate-500" }, [
...
const __nuxt_component_6 = Object.assign(_sfc_main, { __name: "HoxiModelMini" });
