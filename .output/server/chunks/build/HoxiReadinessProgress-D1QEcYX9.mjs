...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-2" }, _attrs))}><div class="flex items-center justify-between text-xs text-slate-500"><span class="font-medium text-slate-700"> \u6D4B\u8BC4\u8FDB\u5EA6\uFF1A\u7B2C ${ssrInterpolate(__props.currentIndex + 1)} / ${ssrInterpolate(__props.totalQuestions)} \u9898 </span><span class="font-mono tabular-nums text-blue-600 font-semibold">${ssrInterpolate(__props.progressPercent)}% </span></div><div class="h-2 w-full rounded-full bg-slate-100 overflow-hidden"><div class="h-full bg-blue-500 transition-all duration-300 rounded-full" style="${ssrRenderStyle({ width: `${__props.progressPercent}%` })}"></div></div><div class="flex items-center justify-between gap-1 pt-1 overflow-x-auto"><!--[-->`);
...
const __nuxt_component_3 = Object.assign(_sfc_main, { __name: "HoxiReadinessProgress" });
