import { aM as useLocaleRouter, b as _sfc_main$E, a as __nuxt_component_3$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-8 md:space-y-12" }, _attrs))}><div class="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 p-4 sm:p-6 md:p-8 shadow-xs relative overflow-hidden"><div class="max-w-3xl"><div class="flex flex-wrap items-center gap-2 mb-3"><span class="${ssrRenderClass([__props.result.tier.badgeColor, "px-2.5 py-0.5 rounded-full text-xs font-semibold border"])}">${ssrInterpolate(__props.result.tier.title)}</span><span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-white border border-slate-200 text-slate-800 shadow-2xs">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: __props.result.roleMeta.icon,
        class: ["w-3.5 h-3.5", __props.result.roleMeta.color]
      }, null, _parent));
      _push(`<span>${ssrInterpolate(__props.result.roleMeta.name)}</span></span><span class="px-2 py-0.5 rounded-full text-xs font-medium bg-slate-100 text-slate-600 border border-slate-200">${ssrInterpolate(__props.result.archetype.name)}</span></div><div class="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-4 mb-3"><div class="flex items-baseline gap-1"><span class="text-4xl sm:text-5xl md:text-6xl font-black font-mono tabular-nums text-slate-900 tracking-tight">${ssrInterpolate(__props.result.overallScore)}</span><span class="text-base sm:text-lg font-medium text-slate-400 font-mono">/ 100</span></div><div><div class="text-sm sm:text-base md:text-lg font-semibold text-slate-800">${ssrInterpolate(__props.result.tier.subtitle)}</div><div class="text-xs text-blue-600 font-medium font-mono mt-0.5"> \u{1F680} \u51FB\u8D25\u4E86\u5168\u7F51 <strong class="tabular-nums font-bold">${ssrInterpolate(__props.result.percentile)}%</strong> \u7684\u540C\u884C </div></div></div><p class="text-xs sm:text-sm md:text-base text-slate-600 leading-relaxed">${ssrInterpolate(__props.result.tier.summary)}</p><div class="mt-4 pt-3 border-t border-slate-200/80 flex items-start gap-2.5 text-xs sm:text-sm text-slate-700 bg-white/80 rounded-xl p-3 border border-slate-100">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "ph:chat-teardrop-text-bold",
        class: "w-4 sm:w-5 h-4 sm:h-5 text-blue-500 shrink-0 mt-0.5"
      }, null, _parent));
      _push(`<div class="leading-relaxed"><strong class="text-slate-900 font-semibold">\u53EF\u4E50\u7684\u5B9E\u6218\u63D0\u9192\uFF1A</strong><span>${ssrInterpolate(__props.result.tier.advice)}</span></div></div></div></div><div class="grid gap-6 md:gap-8 lg:grid-cols-2 items-start"><div class="rounded-2xl border border-slate-200 bg-white p-4 sm:p-6 md:p-8 space-y-5"><div class="flex items-center justify-between pb-3 border-b border-slate-100"><h3 class="text-base font-bold text-slate-900 flex items-center gap-2">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "ph:chart-polar",
      ...
      _push(`<!--]--></div></section><section class="rounded-2xl border border-amber-200/80 bg-gradient-to-br from-amber-50/60 via-white to-amber-50/30 p-4 sm:p-6 md:p-8 flex flex-col sm:flex-row items-center justify-between gap-5 sm:gap-6"><div class="space-y-2 text-center sm:text-left"><div class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-amber-100 text-amber-800"><span>\u2615 \u627E\u7AD9\u957F\u53EF\u4E50\u4EA4\u6D41</span></div><h4 class="text-base md:text-lg font-bold text-slate-900"> \u60F3\u548C\u66F4\u591A ${ssrInterpolate(__props.result.roleMeta.name)} \u540C\u9891\u804A\u804A\u4E00\u4EBA\u516C\u53F8\u5B9E\u6218\uFF1F </h4><p class="text-xs md:text-sm text-slate-600 leading-relaxed max-w-xl"> \u52A0\u5165\u5408\u559C AI \u72EC\u7ACB\u5F00\u53D1\u8005\u5FAE\u4FE1\u7FA4\uFF0C\u514D\u8D39\u83B7\u53D6\u300A\u4E00\u4EBA\u516C\u53F8 30 \u5929\u6781\u7B80\u8D77\u6B65\u4E0E\u907F\u5751\u6E05\u5355\u300B\uFF0C\u63A2\u8BA8\u771F\u5B9E\u51FA\u6D77\u3001API \u4E13\u7EBF\u9009\u578B\u4E0E\u53D8\u73B0\u590D\u76D8\u3002 </p></div><button type="button" class="w-full sm:w-auto shrink-0 px-5 py-2.5 rounded-xl bg-slate-900 text-white hover:bg-amber-600 text-xs sm:text-sm font-semibold transition-colors shadow-xs text-center"> \u52A0\u53EF\u4E50\u5FAE\u4FE1 / \u8FDB\u7FA4 </button></section><div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 pt-6 border-t border-slate-200"><button type="button" class="inline-flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-slate-600 hover:text-slate-900 transition-colors py-2 px-4 rounded-xl hover:bg-slate-100 border border-slate-200 w-full sm:w-auto">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "ph:arrow-counter-clockwise-bold",
        class: "w-4 h-4"
      }, null, _parent));
      _push(`<span>\u6362\u4E2A\u5C97\u4F4D\u91CD\u65B0\u6D4B\u4E00\u6B21</span></button><div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 w-full sm:w-auto"><button type="button" class="${ssrRenderClass([copied.value ? "bg-emerald-50 text-emerald-700 border-emerald-300" : "bg-white text-slate-700 border-slate-300 hover:border-slate-400 hover:bg-slate-50", "inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all border shadow-2xs w-full sm:w-auto"])}">`);
      _push(ssrRenderComponent(_component_UIcon, {
