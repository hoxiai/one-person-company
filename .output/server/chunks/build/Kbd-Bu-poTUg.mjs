...
import { as as useAppConfig, aC as useComponentUI, aE as tv, ab as Primitive, R as createSharedComposable } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme), ...((_a = appConfig.ui) == null ? void 0 : _a.kbd) || {} });
    });
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
        class: ui.value({ class: [(_a = unref(uiProp)) == null ? void 0 : _a.base, props.class], color: props.color, variant: props.variant, size: props.size })
      }, _attrs), {
