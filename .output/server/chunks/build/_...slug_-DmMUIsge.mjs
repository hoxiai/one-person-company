...
import { D as useRoute, v as useSettings, G as useExtensions, H as setResponseStatus, u as useHead } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead(() => {
      var _a;
      return { title: `${((_a = page.value) == null ? void 0 : _a.title) || "Extension"} - Admin` };
    });
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(page)) {
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(page).component), _attrs, null), _parent);
      } else {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex min-h-[60vh] items-center justify-center text-gray-500" }, _attrs))}>${ssrInterpolate(_ctx.$t("admin.extensions.notFound"))}</div>`);
      }
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/plugins/[...slug].vue");
