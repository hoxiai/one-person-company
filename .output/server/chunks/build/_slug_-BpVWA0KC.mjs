...
import { C as useRoute, e as useI18n, aL as useLocaleRouter, bl as createError, y as useFetch, bi as useSeoMeta, bj as useJsonLd, a as __nuxt_component_3$1 } from './server.mjs';
import __nuxt_component_6 from './HoxiModelMini-C2tMdf3U.mjs';
...
import { u as useHoxiModels, f as formatScore, a as formatPrice, b as formatContext, c as formatTps, d as formatLatency, g as scoreEntries, h as findAlternatives, U as USD_TO_CNY_CHECKED_AT, j as USD_TO_CNY } from './useHoxiModels-D3S6mr-U.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HoxiModelMini = __nuxt_component_6;
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_HoxiPageHeader, {
              ...
              meta: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a3, _b2;
                if (_push3) {
                  _push3(`<div class="flex flex-wrap items-center gap-2"${_scopeId2}><span class="inline-flex items-center gap-1.5 rounded-full bg-slate-50 px-2.5 py-0.5 text-xs text-slate-500"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("div", { class: "flex flex-wrap items-center gap-2" }, [
                      createVNode("span", { class: "inline-flex items-center gap-1.5 rounded-full bg-slate-50 px-2.5 py-0.5 text-xs text-slate-500" }, [
            ...
            if (recommendedPlans.value.length || recommendedGateways.value.length) {
              ...
              if (recommendedPlans.value.length) {
                ...
                _push2(ssrRenderComponent(_component_HoxiSectionLabel, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`\u{1F4E6} \u8BE5\u6A21\u578B\u63A8\u8350\u7F16\u7A0B\u5957\u9910 (Coding Plans)`);
                    } else {
                      return [
                        createTextVNode("\u{1F4E6} \u8BE5\u6A21\u578B\u63A8\u8350\u7F16\u7A0B\u5957\u9910 (Coding Plans)")
                      ];
                    }
                  }),
                  _: 1
                ...
                ssrRenderList(recommendedPlans.value, (plan) => {
                  ...
                  if (plan.officialUrl) {
                    _push2(`<a${ssrRenderAttr("href", plan.officialUrl)} target="_blank" rel="noopener nofollow" class="text-[11px] text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"${_scopeId}> \u5B98\u7F51\u76F4\u8FBE \u2197 </a>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div></div>`);
              ...
              if (recommendedGateways.value.length) {
                ...
                _push2(ssrRenderComponent(_component_HoxiSectionLabel, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`\u26A1 \u8BE5\u6A21\u578B\u63A8\u8350\u4E13\u7EBF\u4E2D\u8F6C (API Gateways)`);
                    } else {
                      return [
                        createTextVNode("\u26A1 \u8BE5\u6A21\u578B\u63A8\u8350\u4E13\u7EBF\u4E2D\u8F6C (API Gateways)")
                      ];
                    }
                  }),
                  _: 1
                ...
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span${_scopeId2}>\u67E5\u770B\u4E13\u7EBF\u5929\u68AF</span><span${_scopeId2}>\u2192</span>`);
                    } else {
                      return [
                        createVNode("span", null, "\u67E5\u770B\u4E13\u7EBF\u5929\u68AF"),
                        createVNode("span", null, "\u2192")
                      ];
                    }
                  }),
                ...
                ssrRenderList(recommendedGateways.value, (gw) => {
                  ...
                  _push2(ssrRenderComponent(_component_NuxtLink, {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<span class="text-blue-500"${_scopeId2}>\u26A1</span><span class="truncate"${_scopeId2}>${ssrInterpolate(gw.name)}</span>`);
                      } else {
                        return [
                  ...
                  _push2(`</div><div class="mt-2.5 flex items-baseline gap-2"${_scopeId}><span class="text-sm font-bold text-slate-900 dark:text-white"${_scopeId}>${ssrInterpolate(gw.priceLabel)}</span><span class="text-[11px] text-slate-400 line-through"${_scopeId}>\u5B98\u65B9\u53C2\u8003 \xA5${ssrInterpolate(gw.officialPriceCNY)}/M</span></div>`);
                  ...
                  if (gw.url) {
                    _push2(`<a${ssrRenderAttr("href", gw.url)} target="_blank" rel="noopener nofollow" class="text-[11px] text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"${_scopeId}> \u524D\u5F80\u7AD9\u70B9 \u2197 </a>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div></div>`);
                            ...
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", null, [
                                createVNode("div", { class: "flex items-start justify-between gap-2" }, [
                                  createVNode("div", { class: "min-w-0" }, [
                                    ...
                                    createVNode("div", { class: "mt-1 text-[11px] text-slate-400 dark:text-slate-500" }, toDisplayString(plan.region === "domestic" ? "\u{1F1E8}\u{1F1F3} \u56FD\u5185\u76F4\u8FDE" : "\u{1F310} \u5B98\u65B9\u539F\u5382") + " \xB7 " + toDisplayString(plan.priceLabel), 1)
                                  ]),
                              ...
                              createVNode("div", { class: "mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between" }, [
                                ...
                                plan.officialUrl ? (openBlock(), createBlock("a", {
                                  ...
                                  class: "text-[11px] text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
                            ...
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", null, [
                                ...
                                createVNode("div", { class: "mt-2.5 flex items-baseline gap-2" }, [
                                  ...
                                  createVNode("span", { class: "text-[11px] text-slate-400 line-through" }, "\u5B98\u65B9\u53C2\u8003 \xA5" + toDisplayString(gw.officialPriceCNY) + "/M", 1)
                                ]),
