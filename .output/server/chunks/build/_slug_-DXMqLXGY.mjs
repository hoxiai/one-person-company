...
import { aM as useLocaleRouter, t as useSettings, y as useFetch, bk as useSeoMeta, bl as useJsonLd, a as __nuxt_component_3$1, b as _sfc_main$G } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const planSeoTitle = computed(() => {
      return plan.value ? `${plan.value.name}\uFF1A\u4EF7\u683C\u4E0E\u989D\u5EA6\u9650\u5236 | \u53EF\u559C AI` : "\u7F16\u7A0B\u5957\u9910\u8BE6\u60C5 | \u53EF\u559C AI";
    });
    const planSeoDescription = computed(() => {
      if (!plan.value) return "";
      const p = plan.value;
      return `${p.name} (${p.vendorLabel})\uFF1A\u53C2\u8003\u6708\u8D39 ${p.priceLabel} (\u7EA6 \xA5${p.priceMonthlyCNY}/\u6708)\uFF0C\u989D\u5EA6\uFF1A${p.quotaNote}\u3002\u652F\u6301 ${p.models.slice(0, 3).join("\u3001")}\u3002`;
    });
    useSeoMeta({
          ...
          if (_push2) {
            if (plan.value) {
              ...
              ssrRenderList(plan.value.tools, (tool) => {
                _push2(`<span class="rounded bg-slate-100 dark:bg-slate-800 px-2 py-0.5 text-xs text-slate-700 dark:text-slate-300"${_scopeId}>${ssrInterpolate(tool)}</span>`);
              });
              ...
              _push2(`<span${_scopeId}>\u4F18\u70B9</span></h3><ul class="mt-4 space-y-2.5 text-xs sm:text-sm text-slate-700 dark:text-slate-300"${_scopeId}><!--[-->`);
              ...
              _push2(`<span${_scopeId}>\u6CE8\u610F\u4E8B\u9879</span></h3><ul class="mt-4 space-y-2.5 text-xs sm:text-sm text-slate-700 dark:text-slate-300"${_scopeId}><!--[-->`);
              ...
              _push2(`<!--]--></ul></div></section><section id="setup-guide" class="mt-12 rounded-2xl border border-slate-100 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-900/60 p-6 md:p-8"${_scopeId}><div class="border-b border-slate-200/60 dark:border-slate-800 pb-4"${_scopeId}><h3 class="text-base sm:text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2"${_scopeId}><span${_scopeId}>\u53E6\u4E00\u79CD\u7528\u6CD5\uFF1A\u6309\u91CF\u4ED8\u8D39\u7684 API</span></h3><p class="mt-1 text-xs text-slate-500 dark:text-slate-400"${_scopeId}> \u4E0D\u60F3\u5305\u6708\u7684\u8BDD\uFF0C\u4E5F\u53EF\u4EE5\u7528\u6309\u91CF\u4ED8\u8D39\u7684 API Key \u63A5\u5165 Cursor / Cline\u3002\u4E0B\u9762\u7684\u793A\u4F8B\u7528\u7684\u662F\u6211\u81EA\u5DF1\u7684\u7F51\u5173 AINode\u3002 </p></div><div class="mt-6 grid gap-5 md:grid-cols-2"${_scopeId}><div class="rounded-xl bg-slate-900 p-5 font-mono text-xs text-slate-200"${_scopeId}><div class="text-slate-400 font-semibold border-b border-slate-800 pb-2 mb-3 flex items-center justify-between dark:text-slate-500"${_scopeId}><span${_scopeId}># Cursor IDE \u8BBE\u7F6E</span><span class="text-[10px] text-emerald-400 font-sans"${_scopeId}>AINode</span></div><p class="text-slate-400 dark:text-slate-500"${_scopeId}>\u8DEF\u5F84: Settings -&gt; Models -&gt; OpenAI API Key</p><p class="mt-2 text-slate-400 dark:text-slate-500"${_scopeId}>Base URL:</p><p class="text-emerald-400 font-bold"${_scopeId}>https://api.ainode.run/v1</p><p class="mt-2 text-slate-400 dark:text-slate-500"${_scopeId}>API Key:</p><p class="text-blue-400"${_scopeId}>sk-your-api-key</p><p class="mt-2 text-slate-400 dark:text-slate-500"${_scopeId}>Model Name:</p><p class="text-amber-300"${_scopeId}>\u4EE5 AINode \u540E\u53F0\u7684\u6A21\u578B\u5217\u8868\u4E3A\u51C6</p></div><div class="rounded-xl bg-slate-900 p-5 font-mono text-xs text-slate-200"${_scopeId}><div class="text-slate-400 font-semibold border-b border-slate-800 pb-2 mb-3 flex items-center justify-between dark:text-slate-500"${_scopeId}><span${_scopeId}># VS Code (Cline / Roo Code / Continue)</span><span class="text-[10px] text-blue-400 font-sans"${_scopeId}>AINode</span></div><p class="text-slate-400 dark:text-slate-500"${_scopeId}>API Provider: OpenAI Compatible</p><p class="mt-2 text-slate-400 dark:text-slate-500"${_scopeId}>Base URL:</p><p class="text-emerald-400 font-bold"${_scopeId}>https://api.ainode.run/v1</p></div></div></section>`);
                      ...
                      if (_push3) {
                        ...
                        return [
                          ...
                          createVNode("div", { class: "mt-3 flex items-center justify-between text-[11px] text-blue-600 dark:text-blue-400 font-medium" }, [
                            createVNode("span", null, toDisplayString(alt.region === "domestic" ? "\u56FD\u5185" : "\u56FD\u5916"), 1),
              ...
              _push2(`<div class="py-20 text-center space-y-4"${_scopeId}><h2 class="text-xl font-bold text-slate-900 dark:text-white"${_scopeId}>\u672A\u627E\u5230\u5BF9\u5E94\u7F16\u7A0B\u5957\u9910</h2><p class="text-xs text-slate-500 dark:text-slate-400"${_scopeId}>\u8BE5\u5957\u9910\u53EF\u80FD\u5DF2\u4E0B\u67B6\u6216\u6807\u8BC6\u6709\u8BEF</p>`);
              _push2(ssrRenderComponent(_component_NuxtLink, {
                to: unref(localePath)("/coding-plans"),
            ...
            return [
              plan.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("section", {
                  ...
                  createVNode("div", { class: "border-b border-slate-200/60 dark:border-slate-800 pb-4" }, [
                    createVNode("h3", { class: "text-base sm:text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2" }, [
                      createVNode("span", null, "\u53E6\u4E00\u79CD\u7528\u6CD5\uFF1A\u6309\u91CF\u4ED8\u8D39\u7684 API")
                    ]),
                    createVNode("p", { class: "mt-1 text-xs text-slate-500 dark:text-slate-400" }, " \u4E0D\u60F3\u5305\u6708\u7684\u8BDD\uFF0C\u4E5F\u53EF\u4EE5\u7528\u6309\u91CF\u4ED8\u8D39\u7684 API Key \u63A5\u5165 Cursor / Cline\u3002\u4E0B\u9762\u7684\u793A\u4F8B\u7528\u7684\u662F\u6211\u81EA\u5DF1\u7684\u7F51\u5173 AINode\u3002 ")
                  ]),
                  createVNode("div", { class: "mt-6 grid gap-5 md:grid-cols-2" }, [
                    createVNode("div", { class: "rounded-xl bg-slate-900 p-5 font-mono text-xs text-slate-200" }, [
                      createVNode("div", { class: "text-slate-400 font-semibold border-b border-slate-800 pb-2 mb-3 flex items-center justify-between dark:text-slate-500" }, [
                        ...
                        createVNode("span", { class: "text-[10px] text-emerald-400 font-sans" }, "AINode")
                      ]),
                    ...
                    createVNode("div", { class: "rounded-xl bg-slate-900 p-5 font-mono text-xs text-slate-200" }, [
                      createVNode("div", { class: "text-slate-400 font-semibold border-b border-slate-800 pb-2 mb-3 flex items-center justify-between dark:text-slate-500" }, [
                        ...
                        createVNode("span", { class: "text-[10px] text-blue-400 font-sans" }, "AINode")
                      ]),
                ...
                createVNode("p", { class: "text-xs text-slate-500 dark:text-slate-400" }, "\u8BE5\u5957\u9910\u53EF\u80FD\u5DF2\u4E0B\u67B6\u6216\u6807\u8BC6\u6709\u8BEF"),
                createVNode(_component_NuxtLink, {
                  to: unref(localePath)("/coding-plans"),
                  class: "inline-flex items-center gap-1.5 rounded-full bg-slate-900 dark:bg-blue-600 px-4 py-2 text-xs font-semibold text-white hover:bg-blue-600 transition-colors"
                }, {
