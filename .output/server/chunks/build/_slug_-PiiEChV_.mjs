...
import { aM as useLocaleRouter, v as useSettings, z as useFetch, bl as useSeoMeta, bm as useJsonLd, a as __nuxt_component_3$1, b as _sfc_main$G } from './server.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (plan.value) {
              ...
              _push2(`</div></div></div><section class="mt-10"${_scopeId}>`);
