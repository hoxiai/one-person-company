import { C as useRoute, e as useI18n, aM as useLocaleRouter, f as useFormatTime, y as useFetch, bj as useSeoMeta, bk as useJsonLd, a as __nuxt_component_3$1, b as _sfc_main$E, k as _sfc_main$z } from './server.mjs';
...
import { u as useHoxiModels, i as injectModelReferences } from './useHoxiModels-CB4dunlj.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useSeoMeta({
      title: () => {
        var _a;
        return ((_a = post.value) == null ? void 0 : _a.title) ? `${post.value.title} \xB7 \u5408\u559C AI` : "\u6587\u7AE0\u8BE6\u60C5 \xB7 \u5408\u559C AI";
      },
      description: () => {
        var _a, _b;
