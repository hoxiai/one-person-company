import { br as useCookie, h as useAdminPermissions, v as useAsyncData, _ as _export_sfc, t as useSettings, bq as useLocalizedSettings, e as useI18n, J as useAdminSession, q as navigateTo, a as __nuxt_component_3$1, k as _sfc_main$z, b8 as __nuxt_component_2$2, i as useAdminExtensions, w as themeExtensionPermissionCode, K as __nuxt_component_0$1, b as _sfc_main$E, C as useRoute, p as _sfc_main$q, bo as useDebounceFn, ba as useEventListener$1, aq as useLocale, ar as useAppConfig, aB as useComponentUI, ai as useForwardPropsEmits, aC as reactivePick, at as createReusableTemplate, aD as tv, bn as refThrottled, ax as _sfc_main$A, ay as pickLinkProps, aw as get, aA as omit, az as _sfc_main$B, av as _sfc_main$C, aR as _sfc_main$D, d as _sfc_main$i, aa as Primitive, bp as useActiveElement } from './server.mjs';
import { _ as __nuxt_component_1$1, a as _sfc_main$8 } from './Slideover-BhomJiSu.mjs';
import { _ as _sfc_main$a, u as useKbd } from './Kbd-D7BXxJrX.mjs';
...
import { g as getEstimateSize, L as ListboxItem_default, a as ListboxItemIndicator_default, b as ListboxRoot_default, c as ListboxFilter_default, f as ListboxContent_default, d as ListboxVirtualizer_default, e as ListboxGroup_default, h as injectListboxGroupContext } from './virtualizer-C1ov8Oyt.mjs';
import { cV as defu } from '../nitro/nitro.mjs';
import { useFuse } from '@vueuse/integrations/useFuse';
import { useRouter } from 'vue-router';
import { u as useColorMode } from './composables-CkksJ_Bs.mjs';
import { _ as _sfc_main$9 } from './Tooltip-C7KhY2S3.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(DefineItemTemplate), null, {
        default: withCtx(({ item, index, group }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$A, mergeProps(unref(pickLinkProps)(item), { custom: "" }), {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(ListboxItem_default), {
                    ...
                    default: withCtx((_, _push4, _parent4, _scopeId3) => {
                      var _a2, _b, _c, _d;
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$B, mergeProps(slotProps, {
                          "data-slot": "item",
                                    ...
                                    renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : (group == null ? void 0 : group.slot) ? `${group.slot}-leading` : `item-leading`, {
                                      ...
                                      return [
                                        item.loading ? (openBlock(), createBlock(_sfc_main$E, {
                                          ...
                                          "data-slot": "itemLeadingAvatar",
                                          class: ui.value.itemLeadingAvatar({ class: [(_g2 = unref(uiProp)) == null ? void 0 : _g2.itemLeadingAvatar, (_h2 = item.ui) == null ? void 0 : _h2.itemLeadingAvatar], active: active || item.active })
                                        }), null, 16, ["size", "class"])) : item.chip ? (openBlock(), createBlock(_sfc_main$D, mergeProps({
                                          key: 3,
                                          size: ((_i2 = item.ui) == null ? void 0 : _i2.itemLeadingChipSize) || ((_j = unref(uiProp)) == null ? void 0 : _j.itemLeadingChipSize) || ui.value.itemLeadingChipSize(),
                                          inset: "",
                                          standalone: ""
                                    ...
                                    createVNode("span", {
                                      ...
                                      renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : (group == null ? void 0 : group.slot) ? `${group.slot}-trailing` : `item-trailing`, {
                                        ...
                                        return [
                                          ...
                                          ], 2)) : (group == null ? void 0 : group.highlightedIcon) ? (openBlock(), createBlock(_sfc_main$E, {
                                            key: 2,
                                            name: group.highlightedIcon,
                                            "data-slot": "itemTrailingHighlightedIcon",
                                            class: ui.value.itemTrailingHighlightedIcon({ class: [(_f2 = unref(uiProp)) == null ? void 0 : _f2.itemTrailingHighlightedIcon, (_g2 = item.ui) == null ? void 0 : _g2.itemTrailingHighlightedIcon] })
            ...
            return [
              createVNode(_sfc_main$A, mergeProps(unref(pickLinkProps)(item), { custom: "" }), {
                        ...
                        fn: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ssrRenderSlot(_ctx.$slots, "back", { ui: ui.value }, () => {
                              var _a4;
                              _push4(ssrRenderComponent(_sfc_main$z, mergeProps({
                                size: __props.size,
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UKbd = _sfc_main$a;
      const _component_UModal = _sfc_main$q;
      const _component_UCommandPalette = _sfc_main$7;
...
const __nuxt_component_2$1 = Object.assign(_sfc_main$6, { __name: "RouteSearch" });
const theme = {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-5f2fea6c><div class="admin-sidebar-scrollbar flex-1 overflow-y-auto overflow-x-hidden px-3 py-6" data-v-5f2fea6c><div class="space-y-6" data-v-5f2fea6c><!--[-->`);
      ssrRenderList(sections.value, (section) => {
        _push(`<div data-v-5f2fea6c>`);
        if (!collapsed.value) {
          _push(`<h3 class="${ssrRenderClass(unref(adminSectionTitleClass))}" data-v-5f2fea6c>${ssrInterpolate(section.title)}</h3>`);
        } else {
          _push(`<div class="mb-2 border-t border-gray-200/80 dark:border-white/5" data-v-5f2fea6c></div>`);
        }
        _push(`<nav class="space-y-1" data-v-5f2fea6c><!--[-->`);
        ssrRenderList(section.items, (item) => {
          _push(`<!--[-->`);
          if (item.type === "link") {
                  ...
                  _push2(ssrRenderComponent(_component_NuxtLink, {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        ...
                        if (!collapsed.value) {
                          _push3(`<span class="truncate" data-v-5f2fea6c${_scopeId2}>${ssrInterpolate(item.label)}</span>`);
                        } else {
                          _push3(`<!---->`);
                        }
                      } else {
            ...
            _push(`<div class="space-y-0.5" data-v-5f2fea6c>`);
            if (!collapsed.value) {
              _push(`<!--[--><button type="button" class="${ssrRenderClass([isGroupActive(item) ? "text-purple-600 dark:text-purple-400" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-white/70 dark:hover:bg-white/[0.04] dark:hover:text-white", "group flex w-full items-center justify-between gap-2.5 rounded-lg px-3 py-2 text-sm font-medium transition-colors cursor-pointer"])}" data-v-5f2fea6c><div class="flex items-center gap-2.5 min-w-0 truncate" data-v-5f2fea6c>`);
              _push(ssrRenderComponent(_component_UIcon, {
                name: item.icon,
                class: ["h-4 w-4 shrink-0", isGroupActive(item) ? "text-purple-500 dark:text-purple-400" : "text-gray-400"]
              }, null, _parent));
              _push(`<span class="truncate" data-v-5f2fea6c>${ssrInterpolate(item.title)}</span></div>`);
              _push(ssrRenderComponent(_component_UIcon, {
                name: "ph:caret-down-bold",
              ...
              _push(`</button><div class="ml-5 pl-2.5 space-y-0.5 border-l border-gray-200 dark:border-gray-800" style="${ssrRenderStyle(isGroupExpanded(item.key) ? null : { display: "none" })}" data-v-5f2fea6c><!--[-->`);
              ssrRenderList(item.children, (child) => {
                _push(ssrRenderComponent(_component_NuxtLink, {
                  key: child.to,
                  to: child.to,
                  ...
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    if (_push2) {
                      ...
                      _push2(`<span class="truncate" data-v-5f2fea6c${_scopeId}>${ssrInterpolate(child.label)}</span>`);
                    } else {
                      return [
                        createVNode(_component_UIcon, {
                          name: child.icon,
      ...
      _push(`<!--]--></div></div><div class="${ssrRenderClass([collapsed.value ? "justify-center" : "justify-end px-3", "flex items-center border-t border-gray-200/80 p-2 dark:border-white/5"])}" data-v-5f2fea6c>`);
      _push(ssrRenderComponent(_component_UTooltip, {
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-5f2fea6c"]]), { __name: "AdminSidebar" });
