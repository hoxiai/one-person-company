import { bt as useCookie, i as useAdminPermissions, w as useAsyncData, _ as _export_sfc, v as useSettings, bs as useLocalizedSettings, f as useI18n, K as useAdminSession, r as navigateTo, a as __nuxt_component_3$1, l as _sfc_main$B, ba as __nuxt_component_2$2, j as useAdminExtensions, x as themeExtensionPermissionCode, M as __nuxt_component_0$1, b as _sfc_main$G, D as useRoute, bb as useState, q as _sfc_main$s, br as _sfc_main$d, bp as useDebounceFn, bd as useEventListener$1, ar as useLocale, as as useAppConfig, aC as useComponentUI, aj as useForwardPropsEmits, aD as reactivePick, au as createReusableTemplate, aE as tv, bo as refThrottled, ay as _sfc_main$C, az as pickLinkProps, ax as get, aB as omit, aA as _sfc_main$D, aw as _sfc_main$E, aS as _sfc_main$F, d as _sfc_main$k, bq as useActiveElement, ab as Primitive } from './server.mjs';
import { _ as __nuxt_component_1$1, a as _sfc_main$7 } from './Slideover-CJzjV_V0.mjs';
...
const useAdminNav = () => {
  ...
  const storeSectionBase = {
    ...
    items: [
      ...
      { to: "/admin/comments", icon: "ph:chat-circle-dots", labelKey: "admin.nav.comments", permission: "posts" }
    ]
  };
  const storeSection = {
    ...storeSectionBase,
