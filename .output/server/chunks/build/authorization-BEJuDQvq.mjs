import { f as useI18n, g as useFormatTime, h as useToast, t as useConfirm, i as useAdminPermissions, j as useAdminExtensions, A as ADMIN_PERMISSIONS, m as moduleViewCode, k as moduleEditCode, b as _sfc_main$G, l as _sfc_main$B, n as _sfc_main$h, o as _sfc_main$x, c as _sfc_main$l, d as _sfc_main$k, p as _sfc_main$j, q as _sfc_main$s, r as navigateTo, e as _sfc_main$g, s as useRouter } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="mt-8 bg-white dark:bg-[#121214] border border-gray-200 dark:border-gray-800/60 shadow-xl rounded-2xl overflow-hidden"><div class="px-6 py-5 border-b border-gray-200 dark:border-gray-800/60 bg-gray-100 dark:bg-gray-900/20 flex items-center gap-3"><div class="w-8 h-8 rounded-lg bg-indigo-500/20 flex items-center justify-center text-indigo-400">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "ph:chart-bar-fill",
        class: "w-5 h-5"
      }, null, _parent));
      _push(`</div><div><h2 class="text-lg font-semibold text-gray-900 dark:text-white">${ssrInterpolate(_ctx.$t("admin.settings.analytics.title"))}</h2><p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">${ssrInterpolate(_ctx.$t("admin.settings.analytics.subtitle"))}</p></div></div><div class="p-6 space-y-6"><div class="grid grid-cols-1 md:grid-cols-2 gap-6">`);
      _push(ssrRenderComponent(_component_UFormField, {
        label: _ctx.$t("admin.settings.analytics.ga4_id"),
        description: _ctx.$t("admin.settings.analytics.ga4_id_desc")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: __props.form.analytics_ga4_id,
              "onUpdate:modelValue": ($event) => __props.form.analytics_ga4_id = $event,
      ...
      _push(ssrRenderComponent(_component_UFormField, {
        label: _ctx.$t("admin.settings.analytics.gtm_id"),
        description: _ctx.$t("admin.settings.analytics.gtm_id_desc")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: __props.form.analytics_gtm_id,
              "onUpdate:modelValue": ($event) => __props.form.analytics_gtm_id = $event,
      ...
      _push(ssrRenderComponent(_component_UFormField, {
        label: _ctx.$t("admin.settings.analytics.meta_pixel_id"),
        description: _ctx.$t("admin.settings.analytics.meta_pixel_id_desc")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: __props.form.analytics_meta_pixel_id,
              "onUpdate:modelValue": ($event) => __props.form.analytics_meta_pixel_id = $event,
      ...
      _push(ssrRenderComponent(_component_UFormField, {
        label: _ctx.$t("admin.settings.analytics.clarity_id"),
        description: _ctx.$t("admin.settings.analytics.clarity_id_desc")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: __props.form.analytics_clarity_id,
              "onUpdate:modelValue": ($event) => __props.form.analytics_clarity_id = $event,
              placeholder: "e.g. k4x9q2w1z0",
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_component_UFormField, {
        label: _ctx.$t("admin.settings.analytics.custom_head"),
        description: _ctx.$t("admin.settings.analytics.custom_head_desc")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UTextarea, {
              modelValue: __props.form.analytics_custom_head,
              "onUpdate:modelValue": ($event) => __props.form.analytics_custom_head = $event,
              placeholder: "<script async src='https://analytics.example.com/script.js' data-website-id='...'><\/script>",
              rows: 3,
              size: "md",
      ...
      _push(ssrRenderComponent(_component_UFormField, {
        label: _ctx.$t("admin.settings.analytics.custom_body"),
        description: _ctx.$t("admin.settings.analytics.custom_body_desc")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UTextarea, {
              modelValue: __props.form.analytics_custom_body,
              "onUpdate:modelValue": ($event) => __props.form.analytics_custom_body = $event,
              placeholder: "<!-- Custom body scripts or fallback noscript tags -->",
              rows: 3,
              size: "md",
              class: "w-full font-mono text-xs",
              ui: { base: "bg-gray-50 dark:bg-[#09090b]" }
