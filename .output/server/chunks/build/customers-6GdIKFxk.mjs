...
import { _ as _sfc_main$3 } from './Tabs-Bc46P1l_.mjs';
          ...
          if (_push2) {
            if (pending.value) {
              ...
              if (detail.value.user.avatarUrl) {
                _push2(`<img${ssrRenderAttr("src", detail.value.user.avatarUrl)} class="w-10 h-10 rounded-full object-cover border border-gray-200 dark:border-gray-800"${_scopeId}>`);
              } else {
                ...
                createVNode("div", { class: "flex items-start justify-between gap-4 flex-wrap" }, [
                  createVNode("div", { class: "flex items-center gap-3" }, [
                    detail.value.user.avatarUrl ? (openBlock(), createBlock("img", {
                      key: 0,
                      src: detail.value.user.avatarUrl,
