...
import { D as useRoute, b8 as useActiveTheme, bA as themeLayoutLoaders } from './server.mjs';
  ...
  setup(__props) {
    ...
    const activeLayout = computed(() => {
      return defineAsyncComponent(() => {
        if (!activeTheme.value) return import('./default-DEGsG59Z.mjs');
        const loadThemeLayout = themeLayoutLoaders[activeTheme.value];
        if (!loadThemeLayout) {
          return import('./default-DEGsG59Z.mjs');
        }
