import { _ as __nuxt_component_0 } from './EmailVerificationBanner-CaYBLhM_.mjs';
...
import __nuxt_component_4 from './HoxiCommunityModal-CXyD0n2r.mjs';
...
import { u as useColorMode } from './composables-B5Ej6b8a.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HoxiCommunityModal, {
        open: unref(communityOpen),
        "onUpdate:open": ($event) => isRef(communityOpen) ? communityOpen.value = $event : null
      }, null, _parent));
      _push(`</div>`);
    };
  }
