import { _ as __nuxt_component_0 } from './EmailVerificationBanner-ehRGd4l8.mjs';
import { t as useSettings, aL as useLocaleRouter, e as useI18n, a as __nuxt_component_3$1, b as _sfc_main$E } from './server.mjs';
import __nuxt_component_2 from './HoxiLogoIcon-Bixe5XJD.mjs';
import __nuxt_component_4 from './HoxiCommunityModal-C9MKsm3a.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_HoxiLogoIcon, { class: "h-7 w-7 text-slate-900 group-hover:text-blue-600 transition-all duration-150 group-hover:scale-105" }, null, _parent2, _scopeId));
            ...
            return [
              createVNode(_component_HoxiLogoIcon, { class: "h-7 w-7 text-slate-900 group-hover:text-blue-600 transition-all duration-150 group-hover:scale-105" }),
