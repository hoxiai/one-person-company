...
import { v as useSettings, aM as useLocaleRouter, f as useI18n, a as __nuxt_component_3$1, b as _sfc_main$G } from './server.mjs';
import __nuxt_component_2 from './HoxiLogoIcon-ApHSqyZj.mjs';
import __nuxt_component_4 from './HoxiCommunityModal-Bz6S1jIj.mjs';
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createTextVNode, useSSRContext } from 'vue';
...
import { u as useColorMode } from './composables-DIs36eXP.mjs';
...
const en = {
  ...
  nav: {
    ...
    savingsMenuTitle: "Savings Guide",
    savingsMenuNote: "Cost-reduction & model selection playbook",
    allSavings: "View all",
    modelsDesc: "Capability scores and list prices",
    gatewaysDesc: "Latency, uptime and pricing",
    plansDesc: "Subscription and token-pack quotas",
  ...
  tools: {
    title: "Tools",
    subtitle: "Common tools for building, deploying, getting paid and working with AI as an indie developer.",
    seoTitle: "Tools - build, deploy and get paid as an indie developer",
    seoDescription: "Common indie developer tools: AI coding, hosting, databases, domains and international payments."
  },
  home: {
    heroBadge: "A guide to running a one-person company",
    titleLine1: "Harness AI \xB7 One-Person Army",
    titleLine2: "Joyful & Limitless",
    title: "Hoxi AI: Harness AI, One-Person Army, Joyful & Limitless",
    subtitle: "Find your gaps, pick tools that fit, and get your AI costs straight.",
    statusBar: {
      status: "Continuously Verified",
      feat1: "Real Model Pricing",
      feat2: "Cost Reduction Routes",
      feat3: "Coding Plans Comparison",
      feat4: "Solopreneur Tools",
      badge: "100% Independent Testing"
    },
    authorIntro: "I run the AI gateway, and I'm also building Qingpu AI and this site.",
    heroLinks: {
      coding: "Experience Rank",
    ...
    sections: {
      ...
      posts: "AI coding \xB7 Building products \xB7 Going solo",
    ...
    postsEmpty: "No articles yet.",
    dataSummary: "{count} models from {vendors} vendors. Prices from official pricing pages, scores from Artificial Analysis.",
    method: {
      title: "Where the data comes from",
      viewAbout: "Full methodology",
      source: "I copy prices and specs by hand from official vendor pricing pages; capability scores come from Artificial Analysis. Every figure carries the date I checked it.",
      missing: "Missing fields are left blank rather than guessed.",
      update: "I maintain this alone, so it lags. Check the vendor's own page before budgeting."
    },
  ...
  models: {
    ...
    podiumTitle: "Three common picks",
    podiumDesc: "One each for overall score, value and speed, all computed from the leaderboard data.",
    viewMode: {
      table: "Table",
      cards: "Cards"
    },
  ...
  about: {
    title: "About Hoxi AI",
    subtitle: "Harness AI, One-Person Army, Joyful & Limitless \u2014 A full-stack engineer\u2019s solopreneur playbook.",
    seoTitle: "About Hoxi AI - The Solopreneur AI Guide & Founder Notes",
    explore: "Solopreneur Roadmap",
    authorIntro: "I am Coller. A full-stack engineer running the AI gateway, indie commercial SaaS Qingpu, and this platform. Focusing on a sustainable one-person business model powered by AI.",
    tagSolo: "Indie Full-Stack",
    tagAi: "AI Cost & Model Selection",
    tagAudit: "100% Real Production Tested",
    why: {
      title: 'Why Solopreneurship? The Paradigm Shift of "One-Person Army"',
      p1: "In the past, indie makers constantly struggled with an impossible trilemma: great product ideas but overwhelmed by coding, finishing development but struggling with distribution, getting traction but buried by DevOps, support tickets, and server bills.",
      p2: 'Today, generative AI and agents have radically reduced the marginal cost of building and shipping. By leveraging AI properly, a single person can match the output of a 5-to-10-person agile team. Being a "one-person army" is no longer just a metaphor, but a viable, sustainable lifestyle for modern builders.'
    },
    pillars: {
      title: "What Hoxi AI Offers: Four Pillars for the Solopreneur",
      p1: "1. Identify Your Blindspots (Readiness Assessment): Diagnose your strengths and bottlenecks across product, engineering, audience acquisition, and monetization.",
      p2: "2. Demystify AI Costs (Model Benchmarks & Savings): AI is your core production cost. I share real gateway telemetry, baseline pricing, and alternative routes to cut token expenditures by 50%\u201380%.",
      p3: "3. Minimalist Full-Stack Arsenal (Tools & Coding Plans): Tested workflows for coding, hosting, domain setup, automated CI/CD, and global billing \u2014 straightforward and ready to deploy.",
      p4: "4. Unvarnished Production Logs (Refactoring the Self & Blog): Real mental model shifts, launch retrospectives, and post-mortems from daily solopreneur operations."
    },
    values: {
      title: "Joyful & Limitless: The Philosophy of Sustainable Building",
      p1: 'The platform is named Hoxi, and my name is Coller. In Chinese, it naturally forms "Ke Xi Ke Le" \u2014 celebrating achievement while enjoying the journey. Many indie founders inadvertently turn themselves into 24/7 burned-out freelancers.',
      p2: "A genuine one-person business is about taking back agency over your life. Shipping valuable software is worthy of celebration (\u53EF\u559C), while making a living with peace of mind brings real joy (\u53EF\u4E50). The goal of running solo with AI is freedom and dignity."
    },
    principles: {
      title: "My Principles: Authenticity, Transparency, Zero Hype",
      p1: "No get-rich-quick nonsense: You won't find fake promises or hype courses here. Building a one-person business is serious work requiring solid code, genuine distribution, and clear unit economics.",
      p2: "Verifiable data & candid opinions: Pricing is cross-checked against official documentation, relays are benchmarked with real traffic, and subjective opinions are explicitly marked as editorial notes.",
      p3: "Solo, yet not alone: Solopreneurship can be an isolating journey. We maintain an intimate community for like-minded builders to share notes, collaborate, and grow together."
    }
  },
  posts: {
    title: "Blog",
    subtitle: "Notes on AI coding, building products and running a one-person company.",
    seoTitle: "Blog - Hoxi AI",
    seoDescription: "Coller's notes on AI coding, building products and running a one-person company.",
    empty: "No articles published yet.",
    checkBackLater: "New articles will show up here.",
    views: "{count} views",
    toc: "Contents",
  ...
  gateways: {
    ...
    seoTitle: "AI Gateway Comparison - latency, uptime and pricing",
    seoDescription: "Compare AI API gateways reachable from China: latency, uptime, supported models and pricing, with Cursor / Cline setup."
  },
  savings: {
    title: "AI Compute Savings Guide",
    seoTitle: "AI Compute Savings Guide - Hoxi AI",
    seoDescription: "Model prices, gateways and coding plans compared, plus how to choose by usage.",
    decisionBadge: "How I choose",
    decisionDesc: "This is my own judgement, not a measured result.",
    rule1Title: "Light usage: pay as you go",
    rule1Desc: "If you don't use much, a $20\u201340 monthly plan mostly goes unused. Pay for what you use.",
    rule2Title: "Coding every day: get a coding plan",
    rule2Desc: "With heavy completions and multi-file edits every day, flat plans like Cursor or GitHub Copilot work out cheaper.",
    rule3Title: "Batch jobs: try cheap models first",
    rule3Desc: "For batch processing and long documents, run a Chinese or lightweight model first; if it is good enough, skip the flagship. See the leaderboard for price gaps.",
    modelsSectionTitle: "Model capability and price",
    modelsSectionNote: "Top four by value (overall score \xF7 blended price); scores from Artificial Analysis.",
    viewAllModels: "Full leaderboard",
    gatewaysSectionTitle: "Gateways",
    gatewaysSectionNote: "Latency, uptime and price. AI is my own gateway.",
    viewAllGateways: "All gateways",
    plansSectionTitle: "Coding plans",
    plansSectionNote: "Quotas, supported models and limits.",
  ...
  readiness: {
    ...
    subtitle: "12 scenario questions to see what you are still missing for a one-person company.",
    seoTitle: "Solopreneur Readiness Assessment - are you ready to go solo?",
    seoDescription: "For developers, PMs and other IT people: 12 scenario questions on validation, delivery, distribution, cost and mindset."
  },
  projects: {
    title: "What I'm building",
    seoTitle: "What I'm building",
    seoDescription: "Coller's AI products: Hoxi AI, the AI gateway, Qingpu AI and apay, with tech stack and status.",
    badge: "One-person company",
    recommendBtn: "Submit / Recommend Project",
    recommendTip: "Only my own projects for now. If you are building something alone too, get in touch.",
    ...
    emptyDesc: "Nothing in this category yet."
  },
  comment: {
    title: "Discussion & Comments",
    subtitle: "Share your thoughts, experiences and feedback.",
    placeholder: "Leave a comment...",
    authorPlaceholder: "Your nickname *",
    emailPlaceholder: "Email (optional, for avatar)",
    urlPlaceholder: "Website or GitHub (optional)",
    ...
    pendingNotice: "Comment submitted. It will be published after review.",
...
const zh = {
  brand: {
    name: "\u53EF\u559C AI",
    tagline: "\u4E00\u4EBA\u516C\u53F8\u53D1\u5C55\u6307\u5357 \xB7 \u5584\u7528 AI\uFF0C\u4E00\u4EBA\u6210\u519B\uFF0C\u53EF\u559C\u53EF\u4E50"
  },
  nav: {
    home: "\u9996\u9875",
    models: "\u6A21\u578B\u80FD\u529B",
    ...
    cheap: "\u7701\u94B1\u6307\u5357",
    savings: "\u7701\u94B1\u6307\u5357",
    savingsMenuTitle: "\u7701\u94B1\u6307\u5357",
    savingsMenuNote: "\u4E00\u4EBA\u516C\u53F8\u7B97\u529B\u964D\u672C\u4E0E\u9009\u578B\u65B9\u6848",
    allSavings: "\u67E5\u770B\u5168\u90E8",
    modelsDesc: "\u80FD\u529B\u8BC4\u5206\u4E0E\u5B98\u65B9\u4EF7\u683C",
    gatewaysDesc: "\u5EF6\u8FDF\u3001\u5728\u7EBF\u7387\u4E0E\u5355\u4EF7",
    plansDesc: "\u5B98\u65B9\u8BA2\u9605\u4E0E\u8D44\u6E90\u5305\u7684\u989D\u5EA6",
  ...
  plans: {
    ...
    seoDescription: "\u5BF9\u6BD4\u5404\u5BB6 AI \u7F16\u7A0B\u8BA2\u9605 (Coding Plan) \u4E0E Token \u8D44\u6E90\u5305\u7684\u4EF7\u683C\u3001\u989D\u5EA6\u9650\u5236\u3001\u652F\u6301\u6A21\u578B\u4E0E\u4F18\u7F3A\u70B9\u3002"
  },
  tools: {
    title: "\u5168\u6808\u5DE5\u5177\u7BB1",
    seoTitle: "\u5168\u6808\u5DE5\u5177\u7BB1 - \u4E00\u4EBA\u516C\u53F8\u5E38\u7528\u7684\u5F00\u53D1\u3001\u90E8\u7F72\u4E0E\u6536\u6B3E\u5DE5\u5177",
    seoDescription: "\u72EC\u7ACB\u5F00\u53D1\u5E38\u7528\u5DE5\u5177\uFF1AAI \u7F16\u7A0B\u3001\u90E8\u7F72\u3001\u6570\u636E\u5E93\u3001\u57DF\u540D\u4E0E\u6D77\u5916\u6536\u6B3E\u3002"
  },
  home: {
    heroBadge: "\u4E00\u4EBA\u516C\u53F8\u53D1\u5C55\u6307\u5357",
    titleLine1: "\u5584\u7528 AI \xB7 \u4E00\u4EBA\u6210\u519B",
    titleLine2: "\u53EF\u559C\u53EF\u4E50",
    title: "\u5584\u7528 AI\uFF0C\u4E00\u4EBA\u6210\u519B\uFF0C\u53EF\u559C\u53EF\u4E50",
    subtitle: "\u6D4B\u4E00\u6D4B\u77ED\u677F\uFF0C\u6311\u987A\u624B\u7684\u5DE5\u5177\uFF0C\u628A AI \u7684\u8D26\u7B97\u6E05\u695A\u3002",
    statusBar: {
      status: "\u6301\u7EED\u6838\u5B9E\u9A8C\u8BC1",
      feat1: "\u5927\u6A21\u578B\u771F\u5B9E\u5E95\u4EF7",
      feat2: "\u7B97\u529B\u964D\u672C\u5E73\u66FF",
    ...
    authorIntro: "\u6211\u81EA\u5DF1\u7EF4\u62A4 GoPanel\uFF0C\u4E5F\u5728\u505A\u8F7B\u94FA AI \u548C\u8FD9\u4E2A\u7AD9\u3002",
    heroLinks: {
      coding: "\u4E2A\u4EBA\u4F53\u611F\u6392\u540D",
      gateways: "\u9760\u8C31\u4E2D\u8F6C\u63A8\u8350",
      insights: "\u5B9E\u6218\u5FC3\u5F97\u535A\u5BA2"
    ...
    sections: {
      ...
      codingNote: "\u65E5\u5E38\u5199\u4EE3\u7801\u771F\u5B9E\u4F53\u611F\u6392\u5E8F\uFF0C\u9644\u5B9E\u6218\u70B9\u8BC4\u4E0E\u6027\u4EF7\u6BD4\u3002",
      gateways: "\u5168\u90E8\u4E2D\u8F6C\u7AD9",
      gatewaysNote: "\u771F\u5B9E API \u6301\u7EED\u63A2\u6D4B\u5EF6\u8FDF\u3001\u5728\u7EBF\u7387\u4E0E\u6A21\u578B\u4E00\u81F4\u6027\uFF0C\u7B5B\u9009\u4F4E\u5EF6\u8FDF\u3001\u9AD8\u6027\u4EF7\u6BD4\u7684\u53EF\u9760\u4E13\u7EBF\u3002",
      plans: "\u{1F4E6} \u7F16\u7A0B\u5957\u9910\u4E0E Coding Plan",
      plansNote: "\u6309\u91CF\u4E0E\u5305\u6708\u5BF9\u6BD4\uFF0C\u544A\u522B\u6D77\u5916\u5361\u95E8\u69DB\u548C\u5C01\u53F7\u98CE\u9669\u3002",
      posts: "\u5B9E\u6218\u535A\u5BA2",
      postsNote: "\u4E00\u4EBA\u516C\u53F8\u5DE5\u4F5C\u6D41\u3001\u5546\u4E1A\u53D8\u73B0\u590D\u76D8\u4E0E\u907F\u5751\u5B9E\u5F55\u3002",
      picks: "\u672C\u5468\u63A8\u8350",
      leaderboard: "\u5168\u91CF\u6A21\u578B\u699C\u5355",
      about: "\u5173\u4E8E\u7AD9\u957F",
      categories: "\u699C\u5355\u5206\u7C7B",
    ...
    method: {
      title: "\u6570\u636E\u4ECE\u54EA\u6765",
      viewAbout: "\u5B8C\u6574\u53E3\u5F84",
      source: "\u4EF7\u683C\u548C\u89C4\u683C\u6211\u4ECE\u5382\u5546\u5B98\u65B9\u5B9A\u4EF7\u9875\u9010\u6761\u6284\u5F55\uFF0C\u80FD\u529B\u8BC4\u5206\u53D6\u81EA Artificial Analysis\uFF0C\u6BCF\u6761\u90FD\u6807\u4E86\u6838\u5BF9\u65E5\u671F\u3002",
      missing: "\u67E5\u4E0D\u5230\u7684\u5B57\u6BB5\u4E00\u5F8B\u7559\u7A7A\uFF0C\u4E0D\u778E\u731C\u7740\u586B\u3002",
      update: "\u6570\u636E\u6211\u4E00\u4E2A\u4EBA\u7EF4\u62A4\uFF0C\u4F1A\u6709\u6EDE\u540E\u3002\u6B63\u5F0F\u6838\u7B97\u524D\u8BF7\u4EE5\u5382\u5546\u9875\u9762\u4E3A\u51C6\u3002"
    },
  ...
  models: {
    title: "AI \u6A21\u578B\u6392\u884C\u699C",
    subtitle: "\u5927\u6A21\u578B\u8BE5\u7528\u54EA\u4E2A\uFF1F\u54EA\u4E2A\u6700\u5212\u7B97\uFF1F\u6211\u628A\u5199\u4EE3\u7801\u4F53\u611F\u3001\u8DD1\u5206\u548C\u771F\u5B9E\u4EF7\u683C\u5168\u6446\u5728\u8FD9\uFF0C\u76F4\u63A5\u6765\u6284\u4F5C\u4E1A\u3002",
    ...
    podiumTitle: "\u4E09\u4E2A\u5E38\u7528\u9009\u62E9",
    podiumDesc: "\u6309\u7EFC\u5408\u5206\u3001\u6027\u4EF7\u6BD4\u548C\u901F\u5EA6\u5404\u6311\u4E00\u4E2A\uFF0C\u90FD\u662F\u4ECE\u699C\u5355\u6570\u636E\u91CC\u7B97\u51FA\u6765\u7684\u3002",
    viewMode: {
      table: "\u8868\u683C",
      cards: "\u5361\u7247"
    },
  ...
  model: {
    ...
    scoreMissing: "\u8BE5\u6A21\u578B\u672A\u51FA\u73B0\u5728 Artificial Analysis \u5F53\u524D\u699C\u5355\u524D 25 \u540D\u4E2D\uFF0C\u6240\u4EE5\u6211\u8FD9\u91CC\u6682\u65F6\u6CA1\u6709\u5B83\u7684\u7B2C\u4E09\u65B9\u8BC4\u5206\u3002\u8FD9\u7EDD\u4E0D\u4EE3\u8868\u5B83\u80FD\u529B\u5DEE\uFF0C\u53EA\u4EE3\u8868\u7F3A\u5C11\u7EDF\u4E00\u7EF4\u5EA6\u7684\u516C\u5F00\u6D4B\u8BD5\u6570\u636E\u3002",
    scoreDimensions: {
      overall: "\u7EFC\u5408",
      coding: "\u7F16\u7A0B",
      reasoning: "\u63A8\u7406",
    ...
    variantNote: "\u6211\u8FD9\u91CC\u53D6\u7528\u7684\u662F\u300C{variant}\u300D\u63A8\u7406\u6863\u4F4D\u7684\u6570\u636E\uFF1B\u540C\u4E00\u6A21\u578B\u6362\u4E86\u6863\u4F4D\uFF0C\u901F\u5EA6\u4E0E\u8868\u73B0\u90FD\u4F1A\u6709\u660E\u663E\u5DEE\u5F02\u3002",
    pricing: "\u4EF7\u683C\u660E\u7EC6",
    priceItem: "\u9879\u76EE",
    priceOfficial: "\u5B98\u65B9\u6807\u4EF7",
    priceInput: "\u8F93\u5165",
  ...
  about: {
    title: "\u5173\u4E8E\u53EF\u559C AI",
    subtitle: "\u5584\u7528 AI\uFF0C\u4E00\u4EBA\u6210\u519B\uFF0C\u53EF\u559C\u53EF\u4E50 \u2014\u2014 \u4E00\u4E2A\u5168\u6808\u5DE5\u7A0B\u5E08\u7684\u4E00\u4EBA\u516C\u53F8\u5B9E\u8DF5\u624B\u8BB0\u3002",
    seoTitle: "\u5173\u4E8E\u53EF\u559C AI - \u4E00\u4EBA\u516C\u53F8\u53D1\u5C55\u6307\u5357\u4E0E\u7AD9\u957F\u624B\u8BB0",
    explore: "\u4E00\u4EBA\u516C\u53F8\u5B9E\u8DF5\u5730\u56FE",
    authorIntro: "\u6211\u662F\u53EF\u4E50\u3002\u5168\u6808\u5DE5\u7A0B\u5E08\uFF0C\u624B\u5934\u7EF4\u62A4\u7740 GoPanel\u3001\u8F7B\u94FAAI/\u72EC\u7ACB\u7AD9\u7B49\u9879\u76EE\uFF0C\u4EE5\u53CA\u8FD9\u4E2A\u7AD9\u70B9\u3002\u4E0D\u8FFD\u6C42\u878D\u8D44\u62DB\u4EBA\u7684\u5B8F\u5927\u53D9\u4E8B\uFF0C\u6B63\u5728\u8DF5\u884C\u9760 AI \u8D4B\u80FD\u7684\u4E00\u4EBA\u516C\u53F8\u95ED\u73AF\u3002",
    tagSolo: "\u72EC\u7ACB\u5168\u6808\u5F00\u53D1",
    tagAi: "AI \u964D\u672C\u4E0E\u6A21\u578B\u9009\u578B",
    tagAudit: "100% \u771F\u5B9E\u5B9E\u6D4B",
    why: {
      title: "\u4E3A\u4EC0\u4E48\u662F\u4E00\u4EBA\u516C\u53F8\uFF1F\u65F6\u4EE3\u62D0\u70B9\u4E0E\u300C\u4E00\u4EBA\u6210\u519B\u300D",
      p1: "\u8FC7\u53BB\u505A\u8F6F\u4EF6\uFF0C\u72EC\u7ACB\u5F00\u53D1\u8005\u5F80\u5F80\u4F1A\u649E\u4E0A\u6B8B\u9177\u7684\u300C\u4E0D\u53EF\u80FD\u4E09\u89D2\u300D\uFF1A\u61C2\u9700\u6C42\u5199\u4E0D\u5B8C\u4EE3\u7801\uFF0C\u5199\u5B8C\u4EE3\u7801\u4E0D\u4F1A\u505A\u5BA3\u53D1\u83B7\u5BA2\uFF0C\u597D\u4E0D\u5BB9\u6613\u6765\u4E86\u7528\u6237\uFF0C\u53C8\u88AB\u590D\u6742\u7684\u8FD0\u7EF4\u76D1\u63A7\u3001\u5BA2\u670D\u5DE5\u5355\u548C\u9AD8\u6602\u7684\u670D\u52A1\u5668\u8D26\u5355\u62D6\u5F97\u7126\u5934\u70C2\u989D\u3002\u6700\u540E\u4E00\u4E2A\u4EBA\u6D3B\u6210\u4E86\u4E00\u652F\u961F\u4F0D\uFF0C\u4F46\u7D2F\u5F97\u534A\u6B7B\u3002",
      p2: "\u73B0\u5728\u60C5\u51B5\u53D8\u4E86\u3002\u4EE5\u5927\u6A21\u578B\u548C Agent \u4E3A\u4EE3\u8868\u7684 AI \u6280\u672F\uFF0C\u7B2C\u4E00\u6B21\u628A\u7814\u53D1\u548C\u4EA4\u4ED8\u7684\u8FB9\u9645\u6210\u672C\u538B\u5230\u4E86\u6781\u4F4E\u3002\u5584\u7528 AI\uFF0C\u4E00\u4E2A\u4EBA\u7684\u8BA4\u77E5\u548C\u6267\u884C\u529B\u5C31\u80FD\u88AB\u653E\u5927\u6210\u4E00\u4E2A 5 \u5230 10 \u4EBA\u7684\u7CBE\u5E72\u6218\u961F\u3002\u300C\u4E00\u4EBA\u6210\u519B\u300D\u4E0D\u518D\u662F\u6587\u5B66\u4FEE\u8F9E\uFF0C\u800C\u662F\u6211\u4EEC\u8FD9\u4E00\u4EE3\u6280\u672F\u4EBA\u548C\u8D85\u7EA7\u4E2A\u4F53\u6700\u771F\u5B9E\u7684\u751F\u5B58\u8303\u5F0F\u3002"
    },
    pillars: {
      title: "\u8FD9\u4E2A\u7AD9\u80FD\u4E3A\u4F60\u63D0\u4F9B\u4EC0\u4E48\uFF1A\u4E00\u4EBA\u516C\u53F8\u7684\u56DB\u6839\u652F\u67F1",
      p1: "1. \u6D4B\u4E00\u6D4B\u80FD\u529B\u77ED\u677F\uFF08\u80FD\u529B\u6D4B\u8BC4\uFF09\uFF1A\u4ECE\u6253\u5DE5\u4EBA\u5230\u72EC\u7ACB\u7ECF\u8425\uFF0C\u6700\u6015\u7684\u662F\u4E0D\u77E5\u9053\u81EA\u5DF1\u7F3A\u4EC0\u4E48\u3002\u6211\u628A\u4E00\u4EBA\u516C\u53F8\u7684\u80FD\u529B\u62C6\u6210\u4EA7\u54C1\u3001\u6280\u672F\u3001\u83B7\u5BA2\u548C\u5546\u4E1A\u5316\u56DB\u4E2A\u7EF4\u5EA6\uFF0C\u505A\u4E86\u4E00\u5957\u6781\u7B80\u81EA\u6D4B\uFF0C\u5E2E\u4F60\u5FEB\u901F\u770B\u6E05\u5F53\u524D\u7684\u5361\u70B9\u5728\u54EA\u91CC\u3002",
      p2: "2. \u628A\u7B97\u529B\u8D26\u7B97\u5F97\u6E05\u6E05\u695A\u695A\uFF08\u6A21\u578B\u9009\u578B\u4E0E\u964D\u672C\uFF09\uFF1AAI \u662F\u4E00\u4EBA\u516C\u53F8\u6700\u6838\u5FC3\u7684\u751F\u4EA7\u8D44\u6599\uFF0C\u4F46\u4E5F\u6700\u5BB9\u6613\u88AB\u5382\u5546\u7684\u590D\u6742\u8BA1\u8D39\u548C\u9690\u6027\u52A0\u4EF7\u80CC\u523A\u3002\u6211\u628A\u81EA\u5DF1\u6BCF\u5929\u76EF AI \u7F51\u5173\u7684\u771F\u5B9E\u5E95\u4EF7\u3001\u5EF6\u8FDF\u8868\u73B0\u548C\u964D\u672C\u5E73\u66FF\u8DEF\u7EBF\u5168\u62FF\u51FA\u6765\uFF0C\u5E2E\u4F60\u780D\u6389 50% \u5230 80% \u7684\u7B97\u529B\u51A4\u6789\u94B1\u3002",
      p3: "3. \u6781\u7B80\u5168\u6808\u88C5\u5907\u5E93\uFF08\u5DE5\u5177\u7BB1\u4E0E\u7F16\u7A0B\u5957\u9910\uFF09\uFF1A\u5199\u4EE3\u7801\u7528\u4EC0\u4E48\u5DE5\u5177\u3001\u600E\u4E48\u4E70 Cursor / Claude \u5957\u9910\u6700\u5212\u7B97\u3001\u57DF\u540D\u600E\u4E48\u6311\u3001\u4EE3\u7801\u600E\u4E48\u81EA\u52A8\u6784\u5EFA\u3001\u6D77\u5916\u5982\u4F55\u5408\u6CD5\u6536\u6B3E\u2026\u2026\u5168\u662F\u6211\u81EA\u5DF1\u5B9E\u64CD\u8E29\u5751\u540E\u7559\u4E0B\u7684\u8D81\u624B\u88C5\u5907\uFF0C\u4E0D\u6C42\u5927\u800C\u5168\uFF0C\u53EA\u6C42\u5F00\u7BB1\u5373\u7528\u3002",
      p4: "4. \u771F\u5B9E\u7684\u5B9E\u6218\u4E0E\u8E29\u5751\u6D41\u6C34\uFF08\u4E13\u680F\u300A\u5E95\u5C42\u91CD\u6784\u300B\u4E0E\u535A\u5BA2\uFF09\uFF1A\u6CA1\u6709\u7406\u8BBA\u8BF4\u6559\uFF0C\u53EA\u6709\u771F\u5B9E\u7684\u5FC3\u667A\u6A21\u578B\u8FED\u4EE3\u3001\u4EA7\u54C1\u4E0A\u7EBF\u590D\u76D8\u548C\u907F\u5751\u6D41\u6C34\u3002\u6BCF\u4E00\u4E2A\u6210\u529F\u548C\u7FFB\u8F66\u7684\u7EC6\u8282\u90FD\u644A\u5728\u9633\u5149\u4E0B\uFF0C\u7ED9\u540C\u8DEF\u7684\u4F60\u505A\u4E2A\u53C2\u8003\u3002"
    },
    values: {
      title: "\u4EC0\u4E48\u662F\u300C\u53EF\u559C\u53EF\u4E50\u300D\uFF1F\u6211\u773C\u4E2D\u7684\u4E00\u4EBA\u516C\u53F8\u5FC3\u6001",
      p1: "\u8FD9\u4E2A\u7AD9\u53EB\u53EF\u559C AI\uFF0C\u6211\u53EB\u53EF\u4E50\u3002\u5408\u5728\u4E00\u8D77\uFF0C\u6070\u597D\u662F\u300C\u53EF\u559C\u53EF\u4E50\u300D\u3002\u5F88\u591A\u4EBA\u505A\u72EC\u7ACB\u5F00\u53D1\uFF0C\u505A\u7740\u505A\u7740\u53C8\u628A\u81EA\u5DF1\u903C\u6210\u4E86 7x24 \u5C0F\u65F6\u5F85\u547D\u7684\u82E6\u529B\u5916\u5305\uFF0C\u7126\u8651\u5931\u7720\uFF0C\u672C\u672B\u5012\u7F6E\u3002",
      p2: "\u6211\u7406\u89E3\u7684\u4E00\u4EBA\u516C\u53F8\uFF0C\u6838\u5FC3\u662F\u627E\u56DE\u5BF9\u751F\u6D3B\u7684\u638C\u63A7\u6743\u3002\u501F\u52A9 AI \u7684\u6760\u6746\uFF0C\u628A\u4E8B\u60C5\u505A\u6210\u3001\u521B\u9020\u771F\u5B9E\u4EF7\u503C\uFF0C\u8FD9\u662F\u300C\u53EF\u559C\u300D\uFF1B\u4E0D\u88AB\u865A\u8363\u6307\u6807\u7ED1\u67B6\uFF0C\u4ECE\u5BB9\u8D5A\u94B1\u3001\u8FC7\u597D\u751F\u6D3B\uFF0C\u8FD9\u662F\u300C\u53EF\u4E50\u300D\u3002\u4E00\u4EBA\u6210\u519B\uFF0C\u6700\u7EC8\u662F\u4E3A\u4E86\u8BA9\u81EA\u5DF1\u6D3B\u5F97\u66F4\u6709\u677E\u5F1B\u611F\u548C\u5C0A\u4E25\u3002"
    },
    principles: {
      title: "\u6211\u7684\u539F\u5219\uFF1A\u771F\u5B9E\u3001\u900F\u660E\u3001\u4E0D\u5356\u7126\u8651",
      p1: "\u4E0D\u753B\u9020\u5BCC\u5927\u997C\uFF1A\u6211\u4E0D\u4F1A\u5728\u8FD9\u4E2A\u7AD9\u4E0A\u5356\u300C7\u5929\u9760 AI \u6708\u5165\u5341\u4E07\u300D\u7684\u66B4\u5BCC\u795E\u8BDD\u3002\u4E00\u4EBA\u516C\u53F8\u662F\u4E00\u573A\u8BA4\u771F\u7684\u5546\u4E1A\u5B9E\u8DF5\uFF0C\u9700\u8981\u5B9E\u6253\u5B9E\u7684\u4EA7\u54C1\u3001\u4EE3\u7801\u3001\u83B7\u5BA2\u4E0E\u7B97\u529B\u8D26\u672C\uFF0C\u6D6E\u8E81\u7684\u6377\u5F84\u6700\u7EC8\u90FD\u4F1A\u88AB\u5E02\u573A\u6233\u7834\u3002",
      p2: "\u6570\u636E\u771F\u5B9E\u53EF\u6838\u5B9E\uFF1A\u699C\u5355\u4E0A\u6BCF\u4E2A\u6A21\u578B\u7684\u4EF7\u683C\u6211\u4ECE\u5B98\u65B9\u6838\u5BF9\uFF0C\u4E2D\u8F6C\u7AD9\u7684\u5EF6\u8FDF\u6211\u7528\u771F\u91D1\u767D\u94F6\u5B9E\u6D4B\uFF0C\u5DE5\u5177\u548C\u65B9\u6848\u5168\u662F\u6211\u81EA\u5DF1\u7528\u8FC7\u624D\u63A8\u3002\u51E1\u662F\u6211\u4E2A\u4EBA\u7684\u4E3B\u89C2\u4F53\u9A8C\uFF0C\u6211\u90FD\u660E\u786E\u6807\u6CE8\u300C\u7F16\u8F91\u5224\u65AD\u300D\uFF0C\u7EDD\u4E0D\u62FF\u4E2A\u4EBA\u504F\u597D\u5192\u5145\u5BA2\u89C2\u516C\u7406\u3002",
      p3: "\u4E00\u4EBA\u6210\u519B\uFF0C\u4F46\u4E0D\u5B64\u519B\u594B\u6218\uFF1A\u72EC\u7ACB\u63A2\u7D22\u7684\u8DEF\u4E0A\u5BB9\u6613\u611F\u5230\u5B64\u72EC\u548C\u8FF7\u832B\u3002\u6240\u4EE5\u6211\u5EFA\u4E86\u4E00\u4EBA\u516C\u53F8\u4EA4\u6D41\u793E\u7FA4\uFF0C\u628A\u6709\u540C\u9891\u76EE\u6807\u3001\u5728\u771F\u5B9E\u4EA4\u4ED8\u4EA7\u54C1\u7684\u670B\u53CB\u805A\u5728\u4E00\u8D77\u3002\u6211\u4EEC\u4E92\u901A\u6709\u65E0\u3001\u5171\u4EAB\u8D44\u6E90\u3001\u62B1\u56E2\u6210\u957F\u3002"
    }
  },
  posts: {
    title: "\u535A\u5BA2",
    subtitle: "AI \u7F16\u7A0B\u3001\u505A\u4EA7\u54C1\u548C\u4E00\u4EBA\u516C\u53F8\u7684\u8BB0\u5F55\u3002",
    seoTitle: "\u535A\u5BA2 - \u53EF\u559C AI",
    seoDescription: "\u53EF\u4E50\u5173\u4E8E AI \u7F16\u7A0B\u3001\u505A\u4EA7\u54C1\u548C\u4E00\u4EBA\u516C\u53F8\u7684\u8BB0\u5F55\u3002",
    empty: "\u8FD8\u6CA1\u6709\u53D1\u5E03\u6587\u7AE0\u3002",
    checkBackLater: "\u65B0\u6587\u7AE0\u4F1A\u653E\u5728\u8FD9\u91CC\u3002",
    views: "{count} \u6B21\u9605\u8BFB",
    toc: "\u76EE\u5F55",
    pagination: "\u6587\u7AE0\u5206\u9875",
    previous: "\u4E0A\u4E00\u9875",
  ...
  gateways: {
    title: "AI \u4E2D\u8F6C\u7AD9\u63A8\u8350",
    seoTitle: "AI \u4E2D\u8F6C\u7AD9\u63A8\u8350 - \u5EF6\u8FDF\u3001\u5728\u7EBF\u7387\u4E0E\u5355\u4EF7\u5BF9\u6BD4",
    seoDescription: "\u5B9E\u6D4B\u56FD\u5185\u53EF\u7528\u7684 AI API \u4E2D\u8F6C\u4E13\u7EBF\uFF1A\u5EF6\u8FDF\u3001\u5728\u7EBF\u7387\u3001\u652F\u6301\u6A21\u578B\u4E0E\u5355\u4EF7\uFF0C\u9644 Cursor / Cline \u63A5\u5165\u914D\u7F6E\u3002"
  },
  savings: {
    title: "AI \u7B97\u529B\u7701\u94B1\u6307\u5357",
    seoTitle: "AI \u7B97\u529B\u7701\u94B1\u6307\u5357 - \u53EF\u559C AI",
    seoDescription: "\u6A21\u578B\u4EF7\u683C\u3001\u4E2D\u8F6C\u7AD9\u548C\u7F16\u7A0B\u5957\u9910\u7684\u5BF9\u6BD4\uFF0C\u4EE5\u53CA\u6309\u7528\u91CF\u9009\u65B9\u6848\u7684\u529E\u6CD5\u3002",
    decisionBadge: "\u6211\u7684\u9009\u6CD5",
    decisionDesc: "\u8FD9\u662F\u6211\u81EA\u5DF1\u8E29\u5751\u6478\u7D22\u51FA\u6765\u7684\u7ECF\u9A8C\uFF0C\u4E0D\u662F\u642C\u7816\u5957\u516C\u5F0F\u3002",
    rule1Title: "\u5E73\u65F6\u7528\u5F97\u5C11\uFF1A\u76F4\u63A5\u6309\u91CF\u4E70 Token",
    rule1Desc: "\u5982\u679C\u4E0D\u662F\u5929\u5929\u9AD8\u5F3A\u5EA6\u5199\u4EE3\u7801\uFF0C$20-40 \u7684\u6708\u8D39\u591A\u534A\u662F\u767D\u767D\u6D6A\u8D39\u3002\u7528\u591A\u5C11\u6263\u591A\u5C11\uFF0C\u51E0\u5757\u94B1\u80FD\u7528\u597D\u4E45\u3002",
    rule2Title: "\u5929\u5929\u5199\u4EE3\u7801\u91CD\u5EA6\u4F9D\u8D56\uFF1A\u5F00\u7F16\u7A0B\u5957\u9910",
    rule2Desc: "\u6BCF\u5929\u5927\u91CF\u505A\u4EE3\u7801\u8865\u5168\u3001\u6574\u5E93\u91CD\u6784\u548C\u4E0A\u4E0B\u6587\u4FEE\u6539\uFF0CCursor\u3001Copilot \u8FD9\u79CD\u5305\u6708\u5957\u9910\u7B97\u4E0B\u6765\u624D\u771F\u5212\u7B97\u3002",
    rule3Title: "\u8DD1\u6279\u91CF\u6216\u65E5\u5E38\u5C0F\u6D3B\uFF1A\u4F18\u5148\u4FBF\u5B9C\u6A21\u578B",
    rule3Desc: "\u5207\u56FE\u3001\u5199 CRUD\u3001\u957F\u6587\u672C\u5F52\u7EB3\uFF0C\u5148\u62FF\u51E0\u6BDB\u94B1\u7684\u56FD\u4EA7\u6216\u8F7B\u91CF\u6A21\u578B\u8DD1\uFF0C\u641E\u5F97\u5B9A\u5C31\u522B\u6D6A\u8D39\u94B1\u4E0A\u5927\u65D7\u8230\u3002",
    modelsSectionTitle: "\u6A21\u578B\u80FD\u529B\u4E0E\u4EF7\u683C",
    modelsSectionNote: "\u6309\u6027\u4EF7\u6BD4\uFF08\u7EFC\u5408\u5206 \xF7 \u6DF7\u5408\u4EF7\uFF09\u6392\u524D\u56DB\uFF0C\u7EFC\u5408\u5206\u53D6\u81EA Artificial Analysis\u3002",
    viewAllModels: "\u5B8C\u6574\u699C\u5355",
    gatewaysSectionTitle: "\u4E2D\u8F6C\u7AD9",
    gatewaysSectionNote: "\u5EF6\u8FDF\u3001\u5728\u7EBF\u7387\u548C\u5355\u4EF7",
    viewAllGateways: "\u5168\u90E8\u4E2D\u8F6C\u7AD9",
    plansSectionTitle: "\u7F16\u7A0B\u5957\u9910",
    plansSectionNote: "\u989D\u5EA6\u3001\u652F\u6301\u7684\u6A21\u578B\u548C\u9650\u5236\u3002",
    viewAllPlans: "\u5168\u90E8\u5957\u9910",
  ...
  readiness: {
    title: "\u4E00\u4EBA\u516C\u53F8\u80FD\u529B\u6D4B\u8BC4",
    subtitle: "\u6D4B\u6D4B\u4F60\u9002\u4E0D\u9002\u5408\u5355\u5E72\uFF1A12 \u9053\u5B9E\u6218\u96BE\u9898\uFF0C\u770B\u770B\u4F60\u5728\u5199\u4EE3\u7801\u3001\u5546\u4E1A\u641E\u94B1\u8FD8\u662F\u5FC3\u6001\u4E0A\u6700\u5BB9\u6613\u683D\u8DDF\u5934\u3002",
    seoTitle: "\u4E00\u4EBA\u516C\u53F8\u80FD\u529B\u6D4B\u8BC4 \xB7 \u6D4B\u6D4B\u4F60\u9002\u4E0D\u9002\u5408\u5355\u5E72",
    seoDescription: "\u9762\u5411\u7A0B\u5E8F\u5458\u3001\u4EA7\u54C1\u7ECF\u7406\u7B49 IT \u540C\u884C\uFF1A12 \u9053\u5B9E\u6218\u60C5\u666F\u9898\uFF0C\u770B\u4F60\u5728\u505A\u4EA7\u54C1\u3001\u5546\u4E1A\u53D8\u73B0\u3001\u6D41\u91CF\u83B7\u5BA2\u3001\u7B97\u529B\u6210\u672C\u548C\u6297\u632B\u5FC3\u6001\u4E0A\u7684\u771F\u5B9E\u77ED\u677F\u3002"
  },
  projects: {
    title: "\u9879\u76EE\u63A8\u8350",
    seoTitle: "AI\u5B9E\u6218\u9879\u76EE - \u4E00\u4EBA\u516C\u53F8\u5B9E\u6218\u843D\u5730",
    seoDescription: "\u7A0B\u5E8F\u5728\u505A\u7684 AI \u4EA7\u54C1\uFF1A\u53EF\u559C AI\u3001GoPanel\u3001\u8F7B\u94FA AI \u4E0E apay\u7B49\uFF0C\u542B\u6280\u672F\u6808\u4E0E\u8FD0\u884C\u72B6\u6001\u3002",
    badge: "\u4E00\u4EBA\u516C\u53F8\u5B9E\u6218",
    recommendBtn: "\u63A8\u8350 / \u63D0\u4EA4\u9879\u76EE",
    recommendTip: "\u76EE\u524D\u53EA\u6709\u6211\u81EA\u5DF1\u7684\u9879\u76EE\u3002\u4F60\u4E5F\u5728\u4E00\u4E2A\u4EBA\u505A\u4EA7\u54C1\u7684\u8BDD\uFF0C\u6B22\u8FCE\u6765\u804A\u3002",
    ...
    author: "\u521B\u4F5C\u8005",
    emptyTitle: "\u6682\u65E0\u9879\u76EE",
    emptyDesc: "\u8FD9\u4E2A\u5206\u7C7B\u4E0B\u8FD8\u6CA1\u6709\u9879\u76EE\u3002"
  },
  comment: {
    title: "\u8BA8\u8BBA\u4E0E\u53CD\u9988",
    subtitle: "\u6B22\u8FCE\u4EA4\u6D41\u4F7F\u7528\u5FC3\u5F97\u3001\u573A\u666F\u5B9E\u6D4B\u4E0E\u9009\u578B\u5EFA\u8BAE\u3002",
    placeholder: "\u6B22\u8FCE\u7559\u4E0B\u4F60\u7684\u770B\u6CD5...",
    authorPlaceholder: "\u4F60\u7684\u6635\u79F0 *",
    emailPlaceholder: "\u90AE\u7BB1\uFF08\u9009\u586B\uFF0C\u7528\u4E8E\u5C55\u793A\u5934\u50CF\uFF09",
    urlPlaceholder: "\u7F51\u7AD9\u6216 GitHub \u4E3B\u9875\uFF08\u9009\u586B\uFF09",
    loginWithGithub: "\u7528 GitHub \u767B\u5F55",
    submit: "\u53D1\u8868\u8BC4\u8BBA",
    submitting: "\u63D0\u4EA4\u4E2D...",
    reply: "\u56DE\u590D",
    cancel: "\u53D6\u6D88",
    replyTo: "\u56DE\u590D @{name}",
    empty: "\u6682\u65E0\u8BC4\u8BBA\uFF0C\u6765\u53D1\u8868\u7B2C\u4E00\u6761\u770B\u6CD5\u5427\u3002",
    success: "\u8BC4\u8BBA\u53D1\u8868\u6210\u529F",
    pendingNotice: "\u8BC4\u8BBA\u5DF2\u63D0\u4EA4\uFF0C\u5F85\u7BA1\u7406\u5458\u5BA1\u6838\u901A\u8FC7\u540E\u5C06\u516C\u5F00\u663E\u793A\u3002",
    underReview: "\u5BA1\u6838\u4E2D",
    loginAs: "\u5DF2\u767B\u5F55\uFF1A{name}"
  }
};
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", { class: "flex flex-col" }, [
                createVNode("span", { class: "text-base font-bold text-slate-900 dark:text-white tracking-tight leading-none group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" }, toDisplayString(_ctx.$t("hoxi.brand.name")), 1),
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(ssrRenderComponent(_component_UIcon, {
                  ...
                  class: "w-3 h-3 text-slate-400 group-hover:text-blue-500 dark:group-hover:text-blue-400 group-hover:rotate-180 transition-transform duration-200 dark:text-slate-500"
      ...
      if (mobileOpen.value) {
        ...
        ssrRenderList(navItems.value, (item) => {
          ...
          if (item.children && item.children.length) {
            ...
            _push(`<button type="button" class="p-1 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors dark:text-slate-500" aria-label="\u5C55\u5F00\u7701\u94B1\u83DC\u5355">`);
            _push(ssrRenderComponent(_component_UIcon, {
              name: "ph:caret-down-bold",
      ...
      _push(ssrRenderComponent(_component_HoxiCommunityModal, null, null, _parent));
      _push(`</div>`);
    };
  }
});
