...
import { C as useRoute, b7 as useActiveTheme, by as themeLayoutLoaders } from './server.mjs';
  ...
  setup(__props) {
    ...
    const activeLayout = computed(() => {
      return defineAsyncComponent(() => {
        if (!activeTheme.value) return import('./default-CCj4jst1.mjs');
        const loadThemeLayout = themeLayoutLoaders[activeTheme.value];
        if (!loadThemeLayout) {
          return import('./default-CCj4jst1.mjs');
        }
