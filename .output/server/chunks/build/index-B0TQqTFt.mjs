...
import { f as useI18n, aM as useLocaleRouter, v as useSettings, z as useFetch, bl as useSeoMeta, bm as useJsonLd, b as _sfc_main$G, a as __nuxt_component_3$1 } from './server.mjs';
import __nuxt_component_2 from './HoxiHomeReadiness-BOLwZmZC.mjs';
import __nuxt_component_4 from './HoxiPostItem-CqoOwlVj.mjs';
import __nuxt_component_5 from './HoxiHomeSavingsCard-D1R8qSHI.mjs';
import __nuxt_component_6 from './HoxiHomeTools-CD1J38ie.mjs';
import __nuxt_component_9 from './HoxiHairlineLink-CkLNDE1a.mjs';
import __nuxt_component_4$1 from './HoxiSectionLabel-BHyUHyFd.mjs';
...
import { u as useHoxiModels } from './useHoxiModels-BUR4ZXwz.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HoxiPostItem = __nuxt_component_4;
      const _component_HoxiHomeSavingsCard = __nuxt_component_5;
      const _component_HoxiHomeTools = __nuxt_component_6;
      const _component_HoxiHairlineLink = __nuxt_component_9;
      const _component_HoxiSectionLabel = __nuxt_component_4$1;
            ...
            return [
              createVNode("div", { class: "relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center" }, [
                ...
                createVNode("h1", { class: "text-3xl sm:text-5xl md:text-6xl font-black tracking-tight text-slate-900 dark:text-white leading-[1.18] sm:leading-[1.14]" }, [
                  createVNode("span", null, toDisplayString(_ctx.$t("hoxi.home.titleLine1")), 1),
                  createVNode("span", { class: "block mt-2 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 bg-clip-text text-transparent drop-shadow-xs" }, toDisplayString(_ctx.$t("hoxi.home.titleLine2")), 1)
                ]),
                ...
                createVNode("div", { class: "mt-8 flex items-center justify-center gap-2 text-xs text-slate-400 dark:text-slate-500 font-mono" }, [
                  createVNode("span", { class: "inline-block h-1.5 w-1.5 rounded-full bg-emerald-500" }),
                  createVNode("span", null, "\u4E00\u4EBA\u516C\u53F8\uFF0C\u6210\u957F\u5B9E\u6218\u8BB0\u5F55\u3002\u81F4\u656C\u6BCF\u4E00\u4E2A\u5728\u594B\u6597\u7684\u72EC\u7ACB\u5F00\u53D1\u8005")
                ])
              ])
            ];
          }
      ...
      _push(ssrRenderComponent(_component_HoxiContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</span><h2 class="text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white"${_scopeId}> \u5B9E\u6218\u535A\u5BA2 </h2></div></div>`);
                      ...
                      createVNode("div", { class: "flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-5" }, [
                        createVNode("div", null, [
                          createVNode("div", { class: "flex items-center gap-2" }, [
                            ...
                            createVNode("h2", { class: "text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white" }, " \u5B9E\u6218\u535A\u5BA2 ")
                          ])
                        ]),
