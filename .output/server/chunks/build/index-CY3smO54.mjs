...
import { e as useI18n, C as useRoute, r as useRouter, aL as useLocaleRouter, bi as useSeoMeta, bj as useJsonLd, b as _sfc_main$E, a as __nuxt_component_3$1 } from './server.mjs';
import __nuxt_component_2 from './HoxiModelPodium-Bgiq1Kv3.mjs';
import __nuxt_component_3 from './HoxiModelFilters-BfSPkxDm.mjs';
import __nuxt_component_4 from './HoxiModelTable-C01dnN4O.mjs';
import __nuxt_component_5 from './HoxiModelCard-DaMjXdWK.mjs';
import __nuxt_component_7 from './HoxiSectionLabel-8WOuY8L8.mjs';
import { defineComponent, ref, computed, withCtx, unref, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, Transition, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass } from 'vue/server-renderer';
import { u as useHoxiModels, k as filterModels, s as sortModels, U as USD_TO_CNY_CHECKED_AT, j as USD_TO_CNY } from './useHoxiModels-D3S6mr-U.mjs';
...
import './HoxiValueBar-w_ixP6gD.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useSeoMeta({
      ...
      keywords: "AI\u6A21\u578B\u6392\u884C\u699C, \u5927\u6A21\u578B\u4EF7\u683C\u5BF9\u6BD4, Claude 3.7 Sonnet, DeepSeek R1, GPT-4o, Gemini 2.5, \u5927\u6A21\u578B\u4E0A\u4E0B\u6587, AI\u63A8\u7406\u901F\u5EA6, \u6BCF\u767E\u4E07Token\u4EF7\u683C"
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HoxiModelPodium = __nuxt_component_2;
      const _component_HoxiModelFilters = __nuxt_component_3;
      const _component_HoxiModelTable = __nuxt_component_4;
      const _component_HoxiModelCard = __nuxt_component_5;
      ...
      _push(ssrRenderComponent(_component_HoxiContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-10 md:py-16 space-y-10"${_scopeId}><div class="text-center max-w-3xl mx-auto mb-10 md:mb-14"${_scopeId}><span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 border border-blue-200/70 dark:border-blue-800/60 mb-3 shadow-2xs"${_scopeId}><span class="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse"${_scopeId}></span> \u5B9E\u6218\u4F53\u611F \xB7 \u771F\u5B9E\u4E0D\u865A\u6807 </span><h1 class="text-3xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.title"))}</h1><p class="mt-4 text-base md:text-lg text-slate-600 dark:text-slate-400 leading-relaxed"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.subtitle"))}</p>`);
            if (unref(updatedAt)) {
            ...
            _push2(`</div>`);
            _push2(ssrRenderComponent(_component_HoxiModelPodium, {
              models: unref(models),
              "selected-slugs": selectedForCompare.value,
              onToggleSelect: toggleCompare
            }, null, _parent2, _scopeId));
            _push2(`<div class="space-y-6 pt-2 border-t border-slate-100 dark:border-slate-800"${_scopeId}><nav class="flex flex-wrap gap-x-6 gap-y-2 border-b border-slate-100 dark:border-slate-800 pb-2"${ssrRenderAttr("aria-label", _ctx.$t("hoxi.models.tabsLabel"))}${_scopeId}><!--[-->`);
            ...
            _push2(`</div><div class="flex items-center justify-between text-xs text-slate-400 pt-1"${_scopeId}><p${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.count", { shown: sortedModels.value.length, total: unref(models).length }))}</p>`);
            if (selectedForCompare.value.length) {
              _push2(`<span class="text-blue-600 font-medium font-mono"${_scopeId}> \u5DF2\u52FE\u9009 ${ssrInterpolate(selectedForCompare.value.length)} \u6B3E\u5BF9\u6BD4 </span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            if (sortedModels.value.length) {
              ...
              _push2(`<p class="mt-6 text-sm leading-7 text-slate-500 py-8 text-center"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.noMatch"))}</p>`);
            }
            if (selectedForCompare.value.length) {
              ...
              if (selectedForCompare.value.length >= 2) {
                ...
                _push2(`<span class="text-xs text-slate-400"${_scopeId}> \u8BF7\u518D\u9009 1 \u6B3E </span>`);
              }
              _push2(`<button type="button" class="text-xs text-slate-400 hover:text-white px-2 py-1 transition-colors"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.compareDrawer.clear"))}</button></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<section class="mt-12 border-t border-slate-100 dark:border-slate-800 pt-8"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_HoxiSectionLabel, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("hoxi.models.method.title"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.$t("hoxi.models.method.title")), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<ul class="mt-4 max-w-[720px] space-y-2 text-sm leading-7 text-slate-500 dark:text-slate-400"${_scopeId}><li${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.method.blended"))}</li><li${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.method.currency", { rate: unref(usdToCny), date: unref(rateCheckedAt) }))}</li><li${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.method.valueBar"))}</li><li${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.method.missing"))}</li><li${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.method.variant"))}</li><li${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.models.method.source"))}</li></ul></section></div>`);
          } else {
            return [
              createVNode("div", { class: "py-10 md:py-16 space-y-10" }, [
                createVNode("div", { class: "text-center max-w-3xl mx-auto mb-10 md:mb-14" }, [
                  createVNode("span", { class: "inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 border border-blue-200/70 dark:border-blue-800/60 mb-3 shadow-2xs" }, [
                    createVNode("span", { class: "w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" }),
                    createTextVNode(" \u5B9E\u6218\u4F53\u611F \xB7 \u771F\u5B9E\u4E0D\u865A\u6807 ")
                  ]),
                  ...
                  createVNode("p", { class: "mt-4 text-base md:text-lg text-slate-600 dark:text-slate-400 leading-relaxed" }, toDisplayString(_ctx.$t("hoxi.models.subtitle")), 1),
                ...
                createVNode(_component_HoxiModelPodium, {
                  models: unref(models),
                  "selected-slugs": selectedForCompare.value,
                  onToggleSelect: toggleCompare
                }, null, 8, ["models", "selected-slugs"]),
                ...
                createVNode("div", { class: "flex items-center justify-between text-xs text-slate-400 pt-1" }, [
                  ...
                  selectedForCompare.value.length ? (openBlock(), createBlock("span", {
                    key: 0,
                    class: "text-blue-600 font-medium font-mono"
                ...
                sortedModels.value.length ? (openBlock(), createBlock("div", { key: 0 }, [
                  ...
                  key: 1,
                  class: "mt-6 text-sm leading-7 text-slate-500 py-8 text-center"
                ...
                createVNode("section", { class: "mt-12 border-t border-slate-100 dark:border-slate-800 pt-8" }, [
                  ...
                  createVNode("ul", { class: "mt-4 max-w-[720px] space-y-2 text-sm leading-7 text-slate-500 dark:text-slate-400" }, [
                    createVNode("li", null, toDisplayString(_ctx.$t("hoxi.models.method.blended")), 1),
                    createVNode("li", null, toDisplayString(_ctx.$t("hoxi.models.method.currency", { rate: unref(usdToCny), date: unref(rateCheckedAt) })), 1),
                    createVNode("li", null, toDisplayString(_ctx.$t("hoxi.models.method.valueBar")), 1),
                    createVNode("li", null, toDisplayString(_ctx.$t("hoxi.models.method.missing")), 1),
                    createVNode("li", null, toDisplayString(_ctx.$t("hoxi.models.method.variant")), 1),
                    createVNode("li", null, toDisplayString(_ctx.$t("hoxi.models.method.source")), 1)
                  ])
                ])
              ])
            ];
