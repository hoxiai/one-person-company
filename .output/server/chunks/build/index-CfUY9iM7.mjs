...
import __nuxt_component_5 from './HoxiSpeedTester-BuP0SWPl.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HoxiSpeedTester = __nuxt_component_5;
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(filteredGateways.value, (gw, index) => {
              _push2(`<div class="${ssrRenderClass([gw.isSelfOperated ? "border-blue-300/80 dark:border-blue-800/80 bg-blue-50/20 dark:bg-blue-950/20" : "", "rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-2xs"])}"${_scopeId}><div class="flex items-start justify-between gap-2"${_scopeId}><div class="flex items-center gap-2"${_scopeId}><span class="${ssrRenderClass([index === 0 ? "bg-amber-100 dark:bg-amber-900/60 text-amber-800 dark:text-amber-300" : index === 1 ? "bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200" : index === 2 ? "bg-amber-50 dark:bg-amber-950 text-amber-700 dark:text-amber-400" : "bg-slate-100 dark:bg-slate-800 text-slate-500", "inline-flex h-5 w-5 items-center justify-center rounded-full text-xs font-bold font-mono"])}"${_scopeId}>${ssrInterpolate(index + 1)}</span><div${_scopeId}>`);
              ...
              _push2(`<div class="text-[11px] text-slate-400 font-mono"${_scopeId}>${ssrInterpolate(gw.domain)}</div></div></div><span class="inline-flex items-center rounded bg-emerald-50 dark:bg-emerald-950/60 px-2 py-0.5 text-[11px] font-bold text-emerald-700 dark:text-emerald-400 border border-emerald-200/60 dark:border-emerald-800/60 shrink-0"${_scopeId}> \u76F4\u964D ${ssrInterpolate(gw.savingsPercent)}% </span></div><div class="mt-3 grid grid-cols-3 gap-2 rounded-lg bg-slate-50 dark:bg-slate-800/50 p-2.5 text-center text-xs font-mono"${_scopeId}><div${_scopeId}><div class="text-[10px] text-slate-400 font-sans"${_scopeId}>\u5B9E\u6D4B\u5EF6\u8FDF</div><div class="${ssrRenderClass([gw.latencyMs < 300 ? "text-emerald-600 dark:text-emerald-400" : "text-blue-600 dark:text-blue-400", "font-bold font-mono mt-0.5"])}"${_scopeId}>${ssrInterpolate(gw.latencyMs)}ms </div></div><div${_scopeId}><div class="text-[10px] text-slate-400 font-sans"${_scopeId}>\u5728\u7EBF\u7387</div><div class="font-bold text-emerald-600 dark:text-emerald-400 font-mono mt-0.5"${_scopeId}>${ssrInterpolate(gw.uptime)}</div></div><div${_scopeId}><div class="text-[10px] text-slate-400 font-sans"${_scopeId}>\u8F93\u5165\u5355\u4EF7</div><div class="font-bold text-slate-900 dark:text-white font-mono mt-0.5 text-[11px]"${_scopeId}>${ssrInterpolate(gw.priceLabel)}</div></div></div><div class="mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2"${_scopeId}><button type="button" class="flex-1 rounded-lg border border-slate-200 dark:border-slate-700 py-1.5 text-xs font-medium text-slate-700 dark:text-slate-300 text-center active:bg-slate-100"${_scopeId}>${ssrInterpolate(copiedUrl.value === gw.baseUrl ? "\u5DF2\u590D\u5236 \u2713" : "\u590D\u5236 Base URL")}</button>`);
              _push2(ssrRenderComponent(_component_NuxtLink, {
                to: unref(localePath)(`/gateways/${gw.id}`),
                      ...
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "flex items-start justify-between gap-2" }, [
                          createVNode("div", { class: "flex items-center gap-2" }, [
                            createVNode("span", {
                              class: ["inline-flex h-5 w-5 items-center justify-center rounded-full text-xs font-bold font-mono", index === 0 ? "bg-amber-100 dark:bg-amber-900/60 text-amber-800 dark:text-amber-300" : index === 1 ? "bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200" : index === 2 ? "bg-amber-50 dark:bg-amber-950 text-amber-700 dark:text-amber-400" : "bg-slate-100 dark:bg-slate-800 text-slate-500"]
                            ...
                            createVNode("div", null, [
                              ...
                              createVNode("div", { class: "text-[11px] text-slate-400 font-mono" }, toDisplayString(gw.domain), 1)
                            ])
                          ]),
                          createVNode("span", { class: "inline-flex items-center rounded bg-emerald-50 dark:bg-emerald-950/60 px-2 py-0.5 text-[11px] font-bold text-emerald-700 dark:text-emerald-400 border border-emerald-200/60 dark:border-emerald-800/60 shrink-0" }, " \u76F4\u964D " + toDisplayString(gw.savingsPercent) + "% ", 1)
                        ]),
                        createVNode("div", { class: "mt-3 grid grid-cols-3 gap-2 rounded-lg bg-slate-50 dark:bg-slate-800/50 p-2.5 text-center text-xs font-mono" }, [
                          createVNode("div", null, [
                            createVNode("div", { class: "text-[10px] text-slate-400 font-sans" }, "\u5B9E\u6D4B\u5EF6\u8FDF"),
                            createVNode("div", {
                          ...
                          createVNode("div", null, [
                            createVNode("div", { class: "text-[10px] text-slate-400 font-sans" }, "\u5728\u7EBF\u7387"),
                            createVNode("div", { class: "font-bold text-emerald-600 dark:text-emerald-400 font-mono mt-0.5" }, toDisplayString(gw.uptime), 1)
                          ]),
                          createVNode("div", null, [
                            createVNode("div", { class: "text-[10px] text-slate-400 font-sans" }, "\u8F93\u5165\u5355\u4EF7"),
                        ...
                        createVNode("div", { class: "mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2" }, [
                          createVNode("button", {
                            type: "button",
                            class: "flex-1 rounded-lg border border-slate-200 dark:border-slate-700 py-1.5 text-xs font-medium text-slate-700 dark:text-slate-300 text-center active:bg-slate-100",
