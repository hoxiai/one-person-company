...
import { e as useI18n, aM as useLocaleRouter, t as useSettings, y as useFetch, bj as useSeoMeta, bk as useJsonLd, a as __nuxt_component_3$1, b as _sfc_main$E } from './server.mjs';
import __nuxt_component_4 from './HoxiTag-BAz_5lMM.mjs';
import __nuxt_component_6 from './HoxiCostCalculator-BasckG9c.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const regionFilters = [
      ...
      { key: "domestic", label: "\u56FD\u5185\u5E73\u53F0 (\u76F4\u8FDE/\u652F\u4ED8\u5B9D)", icon: "\u{1F1E8}\u{1F1F3}" },
      { key: "international", label: "\u56FD\u5916\u5E73\u53F0 (\u5B98\u65B9\u539F\u5382/\u65D7\u8230)", icon: "\u{1F310}" }
    ];
    const typeFilters = [
      { key: "all", label: "\u5168\u90E8\u7C7B\u578B" },
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(regionFilters, (region) => {
              _push2(`<button type="button" class="${ssrRenderClass([activeRegion.value === region.key ? "bg-slate-900 dark:bg-blue-600 text-white shadow-sm" : "bg-slate-50 dark:bg-slate-900 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white border border-slate-100 dark:border-slate-800", "rounded-full px-3.5 py-1.5 text-xs font-medium transition-all flex items-center gap-1.5"])}"${_scopeId}><span${_scopeId}>${ssrInterpolate(region.icon)}</span><span${_scopeId}>${ssrInterpolate(region.label)}</span><span class="${ssrRenderClass([activeRegion.value === region.key ? "bg-white/20 text-white" : "text-slate-500 dark:text-slate-400", "ml-0.5 rounded-full bg-slate-200/60 dark:bg-slate-800 px-1.5 py-0.2 text-[10px]"])}"${_scopeId}>${ssrInterpolate(regionCounts.value[region.key])}</span></button>`);
            });
            ...
            _push2(`<!--]--></div><div class="text-xs text-slate-400 dark:text-slate-500"${_scopeId}> \u5F53\u524D\u7B5B\u9009\u51FA ${ssrInterpolate(filteredPlans.value.length)} \u4E2A\u5957\u9910 </div></div></div><div class="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3"${_scopeId}><!--[-->`);
            ssrRenderList(filteredPlans.value, (plan) => {
              ...
              _push2(`<div class="mt-1 flex items-center gap-2 text-[11px] text-slate-400 dark:text-slate-500"${_scopeId}><span${_scopeId}>${ssrInterpolate(plan.vendorLabel)}</span><span${_scopeId}>\xB7</span><span class="text-slate-500 dark:text-slate-400 font-medium"${_scopeId}>${ssrInterpolate(plan.region === "domestic" ? "\u{1F1E8}\u{1F1F3} \u56FD\u5185\u5E73\u53F0" : "\u{1F310} \u56FD\u5916\u5E73\u53F0")}</span></div></div>`);
              if (plan.status === "hot") {
              ...
              if (plan.caveats.length) {
                _push2(`<div class="mt-4 rounded-lg bg-amber-50/50 dark:bg-amber-950/30 p-2.5 text-[11px] leading-5 text-amber-800 dark:text-amber-300 border border-amber-200/50 dark:border-amber-800/30"${_scopeId}><strong class="font-semibold"${_scopeId}>\u907F\u5751\u63D0\u9192\uFF1A</strong>${ssrInterpolate(plan.caveats[0])}</div>`);
              } else {
                _push2(`<!---->`);
              }
            ...
            _push2(`<!--]--></div><section class="mt-14"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_HoxiCostCalculator, null, null, _parent2, _scopeId));
            _push2(`</section><section class="mt-16 border-t border-slate-100 dark:border-slate-800 pt-10"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_HoxiSectionLabel, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    createTextVNode("\u9009\u578B\u5EFA\u8BAE\u4E0E\u5E38\u89C1\u7591\u95EE")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<div class="mt-6 grid gap-6 md:grid-cols-3"${_scopeId}><div class="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5"${_scopeId}><h3 class="text-sm font-semibold text-slate-800 dark:text-slate-200"${_scopeId}> \u56FD\u5916\u5B98\u65B9\u5E73\u53F0 </h3><p class="mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400"${_scopeId}><strong${_scopeId}>\u4F18\u52BF\uFF1A</strong>Claude 3.7 Sonnet / Cursor \u7B49\u9876\u7EA7\u7F16\u7A0B\u6A21\u578B\u4E0E\u539F\u751F\u4F53\u9A8C\u3002<br${_scopeId}><strong${_scopeId}>\u75DB\u70B9\uFF1A</strong>\u9700\u5916\u5E01\u5361\u4E0E\u7EAF\u51C0\u4EE3\u7406\uFF0C\u91CD\u5EA6\u4F7F\u7528\u6613\u9047\u98CE\u63A7\u3002 </p></div><div class="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5"${_scopeId}><h3 class="text-sm font-semibold text-slate-800 dark:text-slate-200"${_scopeId}> \u56FD\u5185\u76F4\u8FDE\u5E73\u53F0 </h3><p class="mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400"${_scopeId}><strong${_scopeId}>\u4F18\u52BF\uFF1A</strong>\u652F\u4ED8\u5B9D\u5FAE\u4FE1\u76F4\u4ED8\uFF0C\u4E13\u7EBF\u8D85\u4F4E\u5EF6\u8FDF\uFF0CDeepSeek \u4E0E Qwen \u5355\u4EF7\u6781\u4F4E\u3002<br${_scopeId}><strong${_scopeId}>\u75DB\u70B9\uFF1A</strong>\u4E0D\u652F\u6301\u95ED\u6E90 Claude \u5B98\u65B9\u6A21\u578B\u3002 </p></div><div class="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5"${_scopeId}><h3 class="text-sm font-semibold text-slate-800 dark:text-slate-200"${_scopeId}> \u63A8\u8350\u642D\u914D\u65B9\u6848 </h3><p class="mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400"${_scopeId}><strong${_scopeId}>\u53CC\u8F6E\u9A71\u52A8\uFF1A</strong>\u590D\u6742\u91CD\u6784\u7528 <strong${_scopeId}>Cursor Pro / Claude</strong>\uFF1B\u65E5\u5E38\u5927\u6279\u91CF\u9AD8\u9891\u8865\u5168\u4E0E\u5355\u6D4B\u914D <strong${_scopeId}>\u56FD\u5185\u4E13\u7EBF\u6309\u91CF Key</strong>\uFF0C\u6708\u6210\u672C\u76F4\u964D 60% \u4EE5\u4E0A\u3002 </p></div></div></section></div>`);
          } else {
            return [
              createVNode("div", { class: "py-8 md:py-16" }, [
                ...
                createVNode("div", { class: "mt-8 space-y-4 border-b border-slate-100 dark:border-slate-800 pb-5" }, [
                  createVNode("div", { class: "flex flex-wrap items-center gap-2" }, [
                    ...
                    (openBlock(), createBlock(Fragment, null, renderList(regionFilters, (region) => {
                      return createVNode("button", {
                        ...
                        createVNode("span", null, toDisplayString(region.icon), 1),
                        createVNode("span", null, toDisplayString(region.label), 1),
                        createVNode("span", {
                          class: ["ml-0.5 rounded-full bg-slate-200/60 dark:bg-slate-800 px-1.5 py-0.2 text-[10px]", activeRegion.value === region.key ? "bg-white/20 text-white" : "text-slate-500 dark:text-slate-400"]
                  ...
                  createVNode("div", { class: "flex flex-wrap items-center justify-between gap-3 pt-1" }, [
                    ...
                    createVNode("div", { class: "text-xs text-slate-400 dark:text-slate-500" }, " \u5F53\u524D\u7B5B\u9009\u51FA " + toDisplayString(filteredPlans.value.length) + " \u4E2A\u5957\u9910 ", 1)
                  ])
                ]),
                    ...
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", null, [
                        createVNode("div", { class: "flex items-start justify-between gap-2" }, [
                          createVNode("div", null, [
                            ...
                            createVNode("div", { class: "mt-1 flex items-center gap-2 text-[11px] text-slate-400 dark:text-slate-500" }, [
                              ...
                              createVNode("span", { class: "text-slate-500 dark:text-slate-400 font-medium" }, toDisplayString(plan.region === "domestic" ? "\u{1F1E8}\u{1F1F3} \u56FD\u5185\u5E73\u53F0" : "\u{1F310} \u56FD\u5916\u5E73\u53F0"), 1)
                            ])
                          ]),
                        ...
                        createVNode("div", { class: "mt-3 flex flex-wrap gap-1.5 text-[11px]" }, [
                          ...
                          createVNode("span", { class: "rounded bg-slate-100 dark:bg-slate-800 px-2 py-0.5 text-slate-600 dark:text-slate-300" }, " \u{1F4B3} " + toDisplayString(plan.paymentMethods.join(" / ")), 1)
                        ]),
                        ...
                        plan.caveats.length ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("strong", { class: "font-semibold" }, "\u907F\u5751\u63D0\u9192\uFF1A"),
                  ...
                  createVNode("div", { class: "mt-6 grid gap-6 md:grid-cols-3" }, [
                    createVNode("div", { class: "rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5" }, [
                      ...
                      createVNode("p", { class: "mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400" }, [
                        ...
                        createTextVNode("Claude 3.7 Sonnet / Cursor \u7B49\u9876\u7EA7\u7F16\u7A0B\u6A21\u578B\u4E0E\u539F\u751F\u4F53\u9A8C\u3002"),
                        createVNode("br"),
                        createVNode("strong", null, "\u75DB\u70B9\uFF1A"),
                        createTextVNode("\u9700\u5916\u5E01\u5361\u4E0E\u7EAF\u51C0\u4EE3\u7406\uFF0C\u91CD\u5EA6\u4F7F\u7528\u6613\u9047\u98CE\u63A7\u3002 ")
                      ])
                    ]),
                    createVNode("div", { class: "rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5" }, [
                      ...
                      createVNode("p", { class: "mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400" }, [
                        createVNode("strong", null, "\u4F18\u52BF\uFF1A"),
                        createTextVNode("\u652F\u4ED8\u5B9D\u5FAE\u4FE1\u76F4\u4ED8\uFF0C\u4E13\u7EBF\u8D85\u4F4E\u5EF6\u8FDF\uFF0CDeepSeek \u4E0E Qwen \u5355\u4EF7\u6781\u4F4E\u3002"),
                        createVNode("br"),
                        createVNode("strong", null, "\u75DB\u70B9\uFF1A"),
                        createTextVNode("\u4E0D\u652F\u6301\u95ED\u6E90 Claude \u5B98\u65B9\u6A21\u578B\u3002 ")
                      ])
                    ]),
                    createVNode("div", { class: "rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5" }, [
                      createVNode("h3", { class: "text-sm font-semibold text-slate-800 dark:text-slate-200" }, " \u63A8\u8350\u642D\u914D\u65B9\u6848 "),
                      createVNode("p", { class: "mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400" }, [
                        createVNode("strong", null, "\u53CC\u8F6E\u9A71\u52A8\uFF1A"),
                        createTextVNode("\u590D\u6742\u91CD\u6784\u7528 "),
                        createVNode("strong", null, "Cursor Pro / Claude"),
                        createTextVNode("\uFF1B\u65E5\u5E38\u5927\u6279\u91CF\u9AD8\u9891\u8865\u5168\u4E0E\u5355\u6D4B\u914D "),
                        createVNode("strong", null, "\u56FD\u5185\u4E13\u7EBF\u6309\u91CF Key"),
                        createTextVNode("\uFF0C\u6708\u6210\u672C\u76F4\u964D 60% \u4EE5\u4E0A\u3002 ")
                      ])
                    ])
                  ])
                ])
