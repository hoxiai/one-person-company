import { t as useSettings, e as useI18n, g as useToast, h as useAdminPermissions, C as useRoute, b as _sfc_main$E, k as _sfc_main$z, d as _sfc_main$i, c as _sfc_main$j, N as _sfc_main$e, o as _sfc_main$h, n as _sfc_main$v, y as useFetch, p as _sfc_main$q, a as __nuxt_component_3$1, ar as useAppConfig, aB as useComponentUI, ah as useForwardProps, aC as reactivePick, aD as tv, av as _sfc_main$C, aa as Primitive } from './server.mjs';
import { i as isSettingsTabId, _ as __nuxt_component_2 } from './Nav-DQUTv58w.mjs';
import { _ as _sfc_main$c } from './Switch-CebXqykj.mjs';
...
import { _ as _sfc_main$d } from './SelectMenu-BoO9dx8r.mjs';
import { _ as _sfc_main$f } from './Checkbox-CxcXUR8O.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(logsLoading)) {
        ...
        ssrRenderList(unref(emailLogsList), (log) => {
          ...
          _push(`</div><div class="flex items-center gap-3 shrink-0"><span class="text-xs text-gray-400">${ssrInterpolate(formatDateTime(log.createdAt))}</span>`);
          if (log.html) {
            _push(ssrRenderComponent(_component_UButton, {
              size: "xs",
              variant: "soft",
