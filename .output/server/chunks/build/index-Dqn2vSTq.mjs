...
import { f as useI18n, aM as useLocaleRouter, v as useSettings, z as useFetch, bl as useSeoMeta, bm as useJsonLd, a as __nuxt_component_3$1, b as _sfc_main$G } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useSeoMeta({
      ...
      description: () => t("hoxi.plans.seoDescription"),
      ogTitle: () => t("hoxi.plans.seoTitle") || t("hoxi.plans.title"),
      ogDescription: () => t("hoxi.plans.seoDescription"),
      ogType: "website",
      twitterCard: "summary_large_image",
      twitterTitle: () => t("hoxi.plans.seoTitle") || t("hoxi.plans.title"),
      twitterDescription: () => t("hoxi.plans.seoDescription"),
