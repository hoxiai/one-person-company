...
import __nuxt_component_1 from './HoxiParticleCanvas-D1QstdUp.mjs';
import __nuxt_component_2 from './HoxiHomeReadiness-B3uwSbvC.mjs';
import __nuxt_component_3 from './HoxiHomeTools-DORmuwOh.mjs';
import __nuxt_component_4 from './HoxiHomeSavingsCard-_0DN-MN5.mjs';
import { e as useI18n, aM as useLocaleRouter, t as useSettings, y as useFetch, bj as useSeoMeta, bk as useJsonLd, b as _sfc_main$E, a as __nuxt_component_3$1 } from './server.mjs';
import __nuxt_component_7 from './HoxiPostItem-ChroJKcl.mjs';
import __nuxt_component_7$1 from './HoxiHairlineLink-B9QTbfu3.mjs';
import __nuxt_component_7$2 from './HoxiSectionLabel-8WOuY8L8.mjs';
import { defineComponent, computed, withAsyncContext, withCtx, createVNode, toDisplayString, unref, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
...
import './useHoxiTools-DcixUNZe.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const siteIntro = computed(() => String(getSetting("site_intro") || t("hoxi.home.subtitle")));
    ...
    useSeoMeta({
      ...
      keywords: "\u4E00\u4EBA\u516C\u53F8, \u72EC\u7ACB\u5F00\u53D1, AI\u6A21\u578B\u6392\u884C\u699C, \u5927\u6A21\u578B\u4EF7\u683C\u5BF9\u6BD4, Claude 3.7 Sonnet, DeepSeek R1, AI\u4E2D\u8F6C\u7AD9, Cursor\u914D\u7F6E, API\u4E13\u7EBF, \u6A21\u578B\u964D\u8D39, \u6EE1\u8840\u601D\u8003"
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HoxiParticleCanvas = __nuxt_component_1;
      ...
      const _component_HoxiPostItem = __nuxt_component_7;
      const _component_HoxiHairlineLink = __nuxt_component_7$1;
      const _component_HoxiSectionLabel = __nuxt_component_7$2;
      _push(`<div${ssrRenderAttrs(_attrs)}><section class="w-full relative overflow-hidden bg-gradient-to-b from-blue-50/60 via-slate-50/20 to-transparent dark:from-slate-900/80 dark:via-slate-950/50 dark:to-transparent pt-8 pb-6 md:pt-12 md:pb-8"><div class="pointer-events-none absolute -left-24 -top-24 h-96 w-96 rounded-full bg-blue-500/10 dark:bg-blue-500/15 blur-3xl"></div><div class="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-indigo-500/10 dark:bg-purple-500/15 blur-3xl"></div><div class="pointer-events-none absolute left-1/2 -top-32 -translate-x-1/2 h-64 w-[600px] rounded-full bg-blue-400/5 dark:bg-blue-400/10 blur-3xl"></div><div class="pointer-events-none absolute inset-0 bg-[radial-gradient(#94a3b8_1px,transparent_1px)] dark:bg-[radial-gradient(#334155_1px,transparent_1px)] [background-size:24px_24px] opacity-20 dark:opacity-25 [mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)]"></div>`);
      _push(ssrRenderComponent(_component_HoxiContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative z-10 grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-center"${_scopeId}><div class="min-w-0"${_scopeId}><span class="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-amber-700 dark:text-amber-300 bg-amber-50/90 dark:bg-amber-950/50 px-3 py-1 rounded-full mb-3 border border-amber-200/80 dark:border-amber-800/60 shadow-2xs"${_scopeId}><span class="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse"${_scopeId}></span><span${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.home.heroBadge"))}</span></span><h1 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-white md:text-4xl leading-snug md:leading-tight"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.home.title"))}</h1><p class="mt-3 text-sm md:text-base leading-7 md:leading-8 text-slate-600 dark:text-slate-300"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.home.subtitle"))}</p><div class="mt-4 inline-flex flex-wrap items-center gap-2 rounded-xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-800/40 px-3.5 py-1.5 text-xs text-amber-900 dark:text-amber-200/90 shadow-2xs"${_scopeId}><span class="text-sm"${_scopeId}>\u2615</span><span class="font-semibold"${_scopeId}>\u53EF\u4E50\u4FBF\u7B7E\uFF1A</span><span class="text-amber-800/90 dark:text-amber-300/80"${_scopeId}>\u7B97\u529B\u522B\u8D2A\u8D35\uFF0C\u4E3B\u529B\u63A7\u5236\u5728\u767E\u5143\u5185\uFF0C\u76F4\u63A5\u6284\u4F5C\u4E1A\u3002</span></div><div class="mt-5 flex flex-wrap items-center gap-2 text-xs md:text-sm"${_scopeId}><span class="text-slate-400 dark:text-slate-500 font-medium"${_scopeId}>\u76F4\u8FBE\uFF1A</span><a href="#home-readiness" class="rounded-full border border-blue-200/80 dark:border-blue-800/80 bg-blue-50/70 dark:bg-blue-950/60 px-3 py-1 text-blue-700 dark:text-blue-300 hover:border-blue-400 hover:shadow-xs transition-all flex items-center gap-1.5 font-medium"${_scopeId}><span${_scopeId}>\u{1F9ED}</span><span${_scopeId}>\u80FD\u529B\u4F53\u68C0</span></a><a href="#home-tools" class="rounded-full border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-3 py-1 text-slate-700 dark:text-slate-300 hover:border-amber-400 hover:text-amber-600 hover:shadow-xs transition-all flex items-center gap-1.5 font-medium"${_scopeId}><span${_scopeId}>\u{1F6E0}\uFE0F</span><span${_scopeId}>\u5168\u6808\u5DE5\u5177</span></a><a href="#home-savings" class="rounded-full border border-amber-300 dark:border-amber-700 bg-amber-50/90 dark:bg-amber-950/60 px-3 py-1 text-amber-800 dark:text-amber-200 hover:border-amber-500 hover:shadow-xs transition-all flex items-center gap-1.5 font-semibold"${_scopeId}><span${_scopeId}>\u{1F4B0}</span><span${_scopeId}>\u7B97\u529B\u964D\u672C</span></a><a href="#recent-posts" class="rounded-full border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-3 py-1 text-slate-700 dark:text-slate-300 hover:border-slate-400 hover:shadow-xs transition-all flex items-center gap-1.5 font-medium"${_scopeId}><span${_scopeId}>\u{1F4BC}</span><span${_scopeId}>\u5B9E\u6218\u4E13\u680F</span></a></div></div><div class="hidden lg:block"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_HoxiParticleCanvas, null, null, _parent2, _scopeId));
            _push2(`</div></div>`);
          } else {
            return [
              createVNode("div", { class: "relative z-10 grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-center" }, [
                createVNode("div", { class: "min-w-0" }, [
                  createVNode("span", { class: "inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-amber-700 dark:text-amber-300 bg-amber-50/90 dark:bg-amber-950/50 px-3 py-1 rounded-full mb-3 border border-amber-200/80 dark:border-amber-800/60 shadow-2xs" }, [
                  ...
                  createVNode("h1", { class: "text-2xl font-bold tracking-tight text-slate-900 dark:text-white md:text-4xl leading-snug md:leading-tight" }, toDisplayString(_ctx.$t("hoxi.home.title")), 1),
                  createVNode("p", { class: "mt-3 text-sm md:text-base leading-7 md:leading-8 text-slate-600 dark:text-slate-300" }, toDisplayString(_ctx.$t("hoxi.home.subtitle")), 1),
                  createVNode("div", { class: "mt-4 inline-flex flex-wrap items-center gap-2 rounded-xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-800/40 px-3.5 py-1.5 text-xs text-amber-900 dark:text-amber-200/90 shadow-2xs" }, [
                    createVNode("span", { class: "text-sm" }, "\u2615"),
                    createVNode("span", { class: "font-semibold" }, "\u53EF\u4E50\u4FBF\u7B7E\uFF1A"),
                    createVNode("span", { class: "text-amber-800/90 dark:text-amber-300/80" }, "\u7B97\u529B\u522B\u8D2A\u8D35\uFF0C\u4E3B\u529B\u63A7\u5236\u5728\u767E\u5143\u5185\uFF0C\u76F4\u63A5\u6284\u4F5C\u4E1A\u3002")
                  ]),
                  createVNode("div", { class: "mt-5 flex flex-wrap items-center gap-2 text-xs md:text-sm" }, [
                    createVNode("span", { class: "text-slate-400 dark:text-slate-500 font-medium" }, "\u76F4\u8FBE\uFF1A"),
                    createVNode("a", {
                      href: "#home-readiness",
                      class: "rounded-full border border-blue-200/80 dark:border-blue-800/80 bg-blue-50/70 dark:bg-blue-950/60 px-3 py-1 text-blue-700 dark:text-blue-300 hover:border-blue-400 hover:shadow-xs transition-all flex items-center gap-1.5 font-medium"
                    }, [
                      createVNode("span", null, "\u{1F9ED}"),
                      createVNode("span", null, "\u80FD\u529B\u4F53\u68C0")
                    ]),
                    createVNode("a", {
                      href: "#home-tools",
                      class: "rounded-full border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-3 py-1 text-slate-700 dark:text-slate-300 hover:border-amber-400 hover:text-amber-600 hover:shadow-xs transition-all flex items-center gap-1.5 font-medium"
                    }, [
                      createVNode("span", null, "\u{1F6E0}\uFE0F"),
                      createVNode("span", null, "\u5168\u6808\u5DE5\u5177")
                    ]),
                    createVNode("a", {
                      href: "#home-savings",
                      class: "rounded-full border border-amber-300 dark:border-amber-700 bg-amber-50/90 dark:bg-amber-950/60 px-3 py-1 text-amber-800 dark:text-amber-200 hover:border-amber-500 hover:shadow-xs transition-all flex items-center gap-1.5 font-semibold"
                    }, [
                      createVNode("span", null, "\u{1F4B0}"),
                      createVNode("span", null, "\u7B97\u529B\u964D\u672C")
                    ]),
                    createVNode("a", {
                      href: "#recent-posts",
                      class: "rounded-full border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-3 py-1 text-slate-700 dark:text-slate-300 hover:border-slate-400 hover:shadow-xs transition-all flex items-center gap-1.5 font-medium"
                    }, [
                      createVNode("span", null, "\u{1F4BC}"),
                      createVNode("span", null, "\u5B9E\u6218\u4E13\u680F")
                    ])
                  ])
                ]),
                createVNode("div", { class: "hidden lg:block" }, [
                  createVNode(_component_HoxiParticleCanvas)
                ])
              ])
            ];
          }
      ...
      _push(ssrRenderComponent(_component_HoxiContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</span><h2 class="text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white"${_scopeId}> \u4E00\u4EBA\u516C\u53F8\u5B9E\u6218\u5FC3\u5F97 </h2><span class="rounded-full bg-amber-50 dark:bg-amber-950/50 px-2 py-0.5 text-[11px] font-medium text-amber-700 dark:text-amber-400"${_scopeId}> \u5546\u4E1A\u5B9E\u64CD </span></div><p class="mt-1 text-xs text-slate-500 dark:text-slate-400"${_scopeId}> \u5546\u4E1A\u95ED\u73AF\u590D\u76D8\u3001AI \u8F85\u52A9\u7F16\u7A0B\u5DE5\u4F5C\u6D41\u4E0E\u5B9E\u64CD\u8E29\u5751\u3002 </p></div>`);
            ...
            if (posts.value.length) {
              ...
              _push2(`<div class="mt-6 rounded-xl border border-dashed border-slate-200 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-900/30 p-8 text-center"${_scopeId}><p class="text-sm leading-7 text-slate-500 dark:text-slate-400"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.home.postsEmpty"))}</p><div class="mt-3 flex justify-center gap-4 text-xs text-slate-400 dark:text-slate-500"${_scopeId}><span${_scopeId}># Cursor\u5B9E\u6218</span><span${_scopeId}># Claude 3.7\u8C03\u4F18</span><span${_scopeId}># \u907F\u5751\u4E0E\u7701\u94B1\u6307\u5357</span></div></div>`);
            }
            _push2(`</section></div><aside class="hidden space-y-8 lg:block lg:sticky lg:top-24 lg:self-start"${_scopeId}><div class="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/40 p-5"${_scopeId}><div class="flex items-center gap-3"${_scopeId}><div class="h-10 w-10 rounded-xl bg-gradient-to-tr from-amber-500 to-orange-500 text-white flex items-center justify-center font-bold text-base shadow-2xs"${_scopeId}> \u559C </div><div${_scopeId}><h3 class="text-sm font-semibold text-slate-900 dark:text-white"${_scopeId}>\u6211\u662F\u53EF\u4E50 (Coller)</h3><p class="text-[11px] text-slate-400 dark:text-slate-500"${_scopeId}>\u5408\u559C AI \u521B\u529E\u4EBA \xB7 \u4E00\u4EBA\u516C\u53F8\u63A2\u7D22\u8005</p></div></div><p class="mt-3 text-xs leading-6 text-slate-600 dark:text-slate-400"${_scopeId}>${ssrInterpolate(siteIntro.value)}</p><button type="button" class="mt-3.5 w-full rounded-xl bg-amber-50/90 dark:bg-amber-950/40 border border-amber-200/80 dark:border-amber-800/60 py-2 px-3 text-xs font-semibold text-amber-900 dark:text-amber-200 hover:bg-amber-100 dark:hover:bg-amber-900/60 transition-all flex items-center justify-center gap-1.5 shadow-2xs"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "ph:chat-circle-dots-bold",
              class: "w-4 h-4 text-amber-600 dark:text-amber-400"
            }, null, _parent2, _scopeId));
            _push2(`<span${_scopeId}>\u627E\u53EF\u4E50\u5FAE\u4FE1 \xB7 \u8FDB\u4E00\u4EBA\u516C\u53F8\u7FA4</span></button><div class="mt-3.5 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_HoxiHairlineLink, { to: "/about" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    createTextVNode(" \u5173\u4E8E\u6211\u4E0E\u4E00\u4EBA\u516C\u53F8\u7406\u5FF5 ")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<a href="https://github.com/hoxiai" target="_blank" rel="noopener noreferrer" class="text-xs text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors flex items-center gap-1"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "ph:github-logo",
              class: "w-3.5 h-3.5"
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="text-[7px] font-mono text-white/80 leading-none"${_scopeId2}>VOL.</span></div><div class="min-w-0 flex-1"${_scopeId2}><h4 class="text-sm font-bold text-white group-hover:text-blue-300 transition-colors leading-tight"${_scopeId2}> \u300A\u5E95\u5C42\u91CD\u6784\u300B </h4><p class="text-[10px] text-slate-300 font-mono mt-0.5"${_scopeId2}> Refactoring the Self </p><p class="text-[11px] text-slate-400 line-clamp-2 mt-1 leading-snug"${_scopeId2}> \u5DE5\u7A0B\u5E08\u89C6\u89D2\u4E0B\u7684\u5FC3\u667A\u6A21\u578B\u4E0E\u5DE5\u4F5C\u6D41\u91CD\u6784\u5B9E\u5F55\u3002 </p></div></div><div class="mt-3 pt-2.5 border-t border-white/10 flex items-center justify-between text-xs text-blue-300 font-medium"${_scopeId2}><span${_scopeId2}>\u8FDB\u5165\u8FDE\u8F7D\u9605\u8BFB</span>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "ph:arrow-right",
                  ...
                  return [
                    ...
                    createVNode("div", { class: "flex items-start gap-3.5 my-1.5" }, [
                      ...
                      createVNode("div", { class: "min-w-0 flex-1" }, [
                        ...
                        createVNode("p", { class: "text-[11px] text-slate-400 line-clamp-2 mt-1 leading-snug" }, " \u5DE5\u7A0B\u5E08\u89C6\u89D2\u4E0B\u7684\u5FC3\u667A\u6A21\u578B\u4E0E\u5DE5\u4F5C\u6D41\u91CD\u6784\u5B9E\u5F55\u3002 ")
                      ])
                    ]),
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`</div><p class="text-[11px] text-slate-500 dark:text-slate-400 mt-1 line-clamp-1"${_scopeId2}>${ssrInterpolate(project.tagline)}</p><div class="mt-1.5 flex items-center justify-between text-[10px] text-slate-400 font-mono"${_scopeId2}><span${_scopeId2}>${ssrInterpolate(project.categoryLabel)}</span>`);
                    ...
                    return [
                      ...
                      createVNode("div", { class: "mt-1.5 flex items-center justify-between text-[10px] text-slate-400 font-mono" }, [
            ...
            _push2(`<!--]--></div></div><div class="rounded-xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-5"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_HoxiSectionLabel, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`\u5B9E\u6218\u4E0E\u8BDD\u9898`);
                  ...
                  return [
                    createTextVNode("\u5B9E\u6218\u4E0E\u8BDD\u9898")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<div class="mt-3 flex flex-wrap gap-2 text-xs text-slate-500 dark:text-slate-400"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              to: unref(localePath)("/readiness"),
              class: "rounded-md bg-slate-50 dark:bg-slate-800 px-2 py-1 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`# \u5C31\u7EEA\u5EA6\u4F53\u68C0`);
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              class: "rounded-md bg-slate-50 dark:bg-slate-800 px-2 py-1 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`# \u5168\u6808\u5DE5\u5177\u7BB1`);
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`# Claude 3.7 \u5B9E\u6D4B`);
                } else {
                  return [
                    createTextVNode("# Claude 3.7 \u5B9E\u6D4B")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`# Coding Plan \u907F\u5751`);
                } else {
                  return [
                    createTextVNode("# Coding Plan \u907F\u5751")
                  ];
                }
              }),
              _: 1
                ...
                createVNode("div", { class: "grid gap-10 md:gap-12 lg:grid-cols-[minmax(0,1fr)_300px]" }, [
                  createVNode("div", { class: "min-w-0 space-y-12 md:space-y-16" }, [
                    ...
                    createVNode("section", { id: "recent-posts" }, [
                      createVNode("div", { class: "flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-5" }, [
                        createVNode("div", null, [
                          createVNode("div", { class: "flex items-center gap-2" }, [
                            ...
                            createVNode("h2", { class: "text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white" }, " \u4E00\u4EBA\u516C\u53F8\u5B9E\u6218\u5FC3\u5F97 "),
                            createVNode("span", { class: "rounded-full bg-amber-50 dark:bg-amber-950/50 px-2 py-0.5 text-[11px] font-medium text-amber-700 dark:text-amber-400" }, " \u5546\u4E1A\u5B9E\u64CD ")
                          ]),
                          createVNode("p", { class: "mt-1 text-xs text-slate-500 dark:text-slate-400" }, " \u5546\u4E1A\u95ED\u73AF\u590D\u76D8\u3001AI \u8F85\u52A9\u7F16\u7A0B\u5DE5\u4F5C\u6D41\u4E0E\u5B9E\u64CD\u8E29\u5751\u3002 ")
                        ]),
                      ...
                      posts.value.length ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "mt-3 flex justify-center gap-4 text-xs text-slate-400 dark:text-slate-500" }, [
                          createVNode("span", null, "# Cursor\u5B9E\u6218"),
                          createVNode("span", null, "# Claude 3.7\u8C03\u4F18"),
                          createVNode("span", null, "# \u907F\u5751\u4E0E\u7701\u94B1\u6307\u5357")
                        ])
                      ]))
                    ])
                  ]),
                  createVNode("aside", { class: "hidden space-y-8 lg:block lg:sticky lg:top-24 lg:self-start" }, [
                    createVNode("div", { class: "rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/40 p-5" }, [
                      createVNode("div", { class: "flex items-center gap-3" }, [
                        ...
                        createVNode("div", null, [
                          ...
                          createVNode("p", { class: "text-[11px] text-slate-400 dark:text-slate-500" }, "\u5408\u559C AI \u521B\u529E\u4EBA \xB7 \u4E00\u4EBA\u516C\u53F8\u63A2\u7D22\u8005")
                        ])
                      ]),
                      ...
                      createVNode("button", {
                        ...
                        createVNode("span", null, "\u627E\u53EF\u4E50\u5FAE\u4FE1 \xB7 \u8FDB\u4E00\u4EBA\u516C\u53F8\u7FA4")
                      ], 8, ["onClick"]),
                      createVNode("div", { class: "mt-3.5 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between" }, [
                        ...
                        createVNode("a", {
                          ...
                          class: "text-xs text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors flex items-center gap-1"
                        }, [
                          createVNode(_component_UIcon, {
                            name: "ph:github-logo",
                            class: "w-3.5 h-3.5"
                    ...
                    createVNode("div", { class: "rounded-xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-5" }, [
                      ...
                      createVNode("div", { class: "mt-3 flex flex-wrap gap-2 text-xs text-slate-500 dark:text-slate-400" }, [
                        createVNode(_component_NuxtLink, {
                          to: unref(localePath)("/readiness"),
                          class: "rounded-md bg-slate-50 dark:bg-slate-800 px-2 py-1 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium"
                        }, {
