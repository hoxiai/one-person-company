      ...
      _push(ssrRenderComponent(_component_HoxiContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mt-6 grid gap-6 md:grid-cols-3"${_scopeId}><div class="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5"${_scopeId}><h4 class="text-sm font-semibold text-slate-900 dark:text-white"${_scopeId}> 1. \u4FBF\u5B9C\u5F97\u79BB\u8C31\u7684\u8981\u7559\u4E2A\u5FC3\u773C </h4><p class="mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400"${_scopeId}> \u6709\u7684\u5E73\u53F0\u6807\u4EF7\u4F4E\u5230\u8FDD\u80CC\u5E38\u7406\uFF0C\u80CC\u540E\u5F88\u53EF\u80FD\u5077\u6881\u6362\u67F1\u628A\u9876\u7EA7\u6A21\u578B\u964D\u7EA7\u6210\u4E86\u4FBF\u5B9C\u8D27\u3002\u62FF\u8DE8\u6587\u4EF6\u91CD\u6784\u6216\u9AD8\u96BE\u5EA6\u7B97\u6CD5\u9898\u62F7\u6253\u4E00\u4E0B\uFF0C\u8F93\u51FA\u6C34\u51C6\u7ACB\u9A6C\u9732\u9985\u3002 </p></div><div class="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5"${_scopeId}><h4 class="text-sm font-semibold text-slate-900 dark:text-white"${_scopeId}> 2. \u7B2C\u4E00\u6B21\u5148\u5C0F\u989D\u5145\u503C\u8BD5\u6C34 </h4><p class="mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400"${_scopeId}> \u505A\u72EC\u7ACB\u5F00\u53D1\u8981\u5BF9\u73B0\u91D1\u6D41\u6781\u5176\u8C28\u614E\u3002\u7B2C\u4E00\u6B21\u5148\u5145\u4E2A \xA510~20 \u8BD5\u7528\uFF0C\u786E\u8BA4\u5199\u4EE3\u7801\u987A\u624B\u3001\u4E0D\u7ECF\u5E38\u62A5\u9519\u6389\u7EBF\uFF0C\u518D\u65E5\u5E38\u7EE7\u7EED\u5145\uFF0C\u522B\u4E00\u4E0A\u6765\u5145\u51E0\u767E\u5757\u5F53\u6C89\u6CA1\u6210\u672C\u3002 </p></div><div class="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5"${_scopeId}><h4 class="text-sm font-semibold text-slate-900 dark:text-white"${_scopeId}> 3. \u5199\u4EE3\u7801\u6700\u770B\u9996\u5B57\u5EF6\u8FDF </h4><p class="mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400"${_scopeId}> IDE \u91CC\u7684 Tab \u8865\u5168\u548C\u591A\u884C\u751F\u6210\uFF0C\u6700\u6015\u5E72\u7B49\u3002\u9996\u5B57\u5EF6\u8FDF\uFF08TTFT\uFF09\u8981\u662F\u8D85\u8FC7 1 \u79D2\u5C31\u4F1A\u6709\u660E\u663E\u7684\u5361\u987F\u6253\u65AD\u611F\uFF0C\u5C3D\u91CF\u9009\u56FD\u5185\u4E13\u7EBF\u76F4\u8FDE\u7684\u8282\u70B9\u3002 </p></div></div></section><section class="mt-14 border-t border-slate-100 dark:border-slate-800 pt-10"${_scopeId}><div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                createVNode("section", { class: "mt-14 border-t border-slate-100 dark:border-slate-800 pt-10" }, [
                  ...
                  createVNode("div", { class: "mt-6 grid gap-6 md:grid-cols-3" }, [
                    createVNode("div", { class: "rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5" }, [
                      createVNode("h4", { class: "text-sm font-semibold text-slate-900 dark:text-white" }, " 1. \u4FBF\u5B9C\u5F97\u79BB\u8C31\u7684\u8981\u7559\u4E2A\u5FC3\u773C "),
                      createVNode("p", { class: "mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400" }, " \u6709\u7684\u5E73\u53F0\u6807\u4EF7\u4F4E\u5230\u8FDD\u80CC\u5E38\u7406\uFF0C\u80CC\u540E\u5F88\u53EF\u80FD\u5077\u6881\u6362\u67F1\u628A\u9876\u7EA7\u6A21\u578B\u964D\u7EA7\u6210\u4E86\u4FBF\u5B9C\u8D27\u3002\u62FF\u8DE8\u6587\u4EF6\u91CD\u6784\u6216\u9AD8\u96BE\u5EA6\u7B97\u6CD5\u9898\u62F7\u6253\u4E00\u4E0B\uFF0C\u8F93\u51FA\u6C34\u51C6\u7ACB\u9A6C\u9732\u9985\u3002 ")
                    ]),
                    createVNode("div", { class: "rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5" }, [
                      createVNode("h4", { class: "text-sm font-semibold text-slate-900 dark:text-white" }, " 2. \u7B2C\u4E00\u6B21\u5148\u5C0F\u989D\u5145\u503C\u8BD5\u6C34 "),
                      createVNode("p", { class: "mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400" }, " \u505A\u72EC\u7ACB\u5F00\u53D1\u8981\u5BF9\u73B0\u91D1\u6D41\u6781\u5176\u8C28\u614E\u3002\u7B2C\u4E00\u6B21\u5148\u5145\u4E2A \xA510~20 \u8BD5\u7528\uFF0C\u786E\u8BA4\u5199\u4EE3\u7801\u987A\u624B\u3001\u4E0D\u7ECF\u5E38\u62A5\u9519\u6389\u7EBF\uFF0C\u518D\u65E5\u5E38\u7EE7\u7EED\u5145\uFF0C\u522B\u4E00\u4E0A\u6765\u5145\u51E0\u767E\u5757\u5F53\u6C89\u6CA1\u6210\u672C\u3002 ")
                    ]),
                    createVNode("div", { class: "rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-900/40 p-5" }, [
                      createVNode("h4", { class: "text-sm font-semibold text-slate-900 dark:text-white" }, " 3. \u5199\u4EE3\u7801\u6700\u770B\u9996\u5B57\u5EF6\u8FDF "),
                      createVNode("p", { class: "mt-2 text-xs leading-6 text-slate-600 dark:text-slate-400" }, " IDE \u91CC\u7684 Tab \u8865\u5168\u548C\u591A\u884C\u751F\u6210\uFF0C\u6700\u6015\u5E72\u7B49\u3002\u9996\u5B57\u5EF6\u8FDF\uFF08TTFT\uFF09\u8981\u662F\u8D85\u8FC7 1 \u79D2\u5C31\u4F1A\u6709\u660E\u663E\u7684\u5361\u987F\u6253\u65AD\u611F\uFF0C\u5C3D\u91CF\u9009\u56FD\u5185\u4E13\u7EBF\u76F4\u8FDE\u7684\u8282\u70B9\u3002 ")
                    ])
                  ])
                ]),
                createVNode("section", { class: "mt-14 border-t border-slate-100 dark:border-slate-800 pt-10" }, [
