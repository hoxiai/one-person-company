...
import __nuxt_component_1 from './HoxiHeroCard-Dt_JsC4D.mjs';
...
import __nuxt_component_7 from './HoxiPostItem-1nOO63qo.mjs';
import __nuxt_component_8 from './HoxiHairlineLink-6_pMzXOE.mjs';
import __nuxt_component_7$1 from './HoxiSectionLabel-BlLbr3V0.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HoxiHeroCard = __nuxt_component_1;
      ...
      const _component_HoxiSectionLabel = __nuxt_component_7$1;
              ...
              createVNode("div", { class: "relative z-10 grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-center" }, [
                createVNode("div", { class: "min-w-0" }, [
                  ...
                  createVNode("div", { class: "mt-5 flex flex-wrap items-center gap-2 text-xs md:text-sm" }, [
                    ...
                    createVNode("a", {
                      href: "#home-tools",
                      class: "rounded-full border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-3 py-1 text-slate-700 dark:text-slate-300 hover:border-amber-400 hover:text-amber-600 hover:shadow-xs transition-all flex items-center gap-1.5 font-medium dark:hover:text-amber-400"
                    }, [
                    ...
                    createVNode("a", {
                      ...
                      createVNode("span", null, "\u5B9E\u6218\u5FC3\u5F97")
                    ])
                  ])
                ]),
                createVNode("div", { class: "hidden lg:block" }, [
                  createVNode(_component_HoxiHeroCard)
                ])
              ])
            ];
          }
