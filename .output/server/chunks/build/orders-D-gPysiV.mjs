import { f as useI18n, g as useFormatTime, J as useCurrencyFormat, D as useRoute, s as useRouter, h as useToast, t as useConfirm, N as useRequestURL, i as useAdminPermissions, y as usePagination, z as useFetch, b as _sfc_main$G, l as _sfc_main$B, p as _sfc_main$j, d as _sfc_main$k, n as _sfc_main$h, o as _sfc_main$x, a as __nuxt_component_3$1, B as _sfc_main$n, c as _sfc_main$l, e as _sfc_main$g, v as useSettings, O as useLocaleCurrency } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UTable, {
        ...
        empty: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col items-center justify-center py-12 text-center px-4"${_scopeId}><div class="w-12 h-12 rounded-2xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 mb-3"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "ph:wallet",
              class: "w-6 h-6"
            }, null, _parent2, _scopeId));
            _push2(`</div><p class="text-sm font-medium text-gray-900 dark:text-white"${_scopeId}>${ssrInterpolate(status.value !== "all" ? unref(t)("admin.topups.noRecordsFound", "\u672A\u627E\u5230\u7B26\u5408\u6761\u4EF6\u7684\u5145\u503C\u8BB0\u5F55") : unref(t)("admin.common.noData", "\u6682\u65E0\u6570\u636E"))}</p></div>`);
          } else {
            return [
              createVNode("div", { class: "flex flex-col items-center justify-center py-12 text-center px-4" }, [
                ...
                createVNode("p", { class: "text-sm font-medium text-gray-900 dark:text-white" }, toDisplayString(status.value !== "all" ? unref(t)("admin.topups.noRecordsFound", "\u672A\u627E\u5230\u7B26\u5408\u6761\u4EF6\u7684\u5145\u503C\u8BB0\u5F55") : unref(t)("admin.common.noData", "\u6682\u65E0\u6570\u636E")), 1)
              ])
            ];
          }
        }),
        loading: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-center py-12 text-center px-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
            ...
            return [
              createVNode("div", { class: "flex items-center justify-center py-12 text-center px-4" }, [
                createVNode(_component_UIcon, {
                  name: "ph:spinner-gap-bold",
                  class: "w-6 h-6 animate-spin text-primary-500"
                })
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const putOrder = (order, confirmSubscriptionImpact) => $fetch(`/api/admin/orders/${order.id}`, {
      method: "PUT",
      body: {
        status: order.status,
        payStatus: order.payStatus,
        deliveryInfo: order.deliveryInfo,
        ...confirmSubscriptionImpact ? { confirmSubscriptionImpact: true } : {}
      }
    });
