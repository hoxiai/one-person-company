...
import { dV as defu } from '../nitro/nitro.mjs';
...
import { u as useFilter, _ as _sfc_main$8 } from './SelectMenu-DOh79w0e.mjs';
...
import __nuxt_component_9$1 from './RichEditor-R-T5BS1y.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const RichEditor = defineAsyncComponent(() => import('./RichEditor-R-T5BS1y.mjs'));
    const props = __props;
    const emit = __emit;
    const { t } = useI18n();
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UInput = _sfc_main$k;
      const _component_UTextarea = _sfc_main$g;
      const _component_RichEditor = __nuxt_component_9$1;
      const _component_UCheckbox = _sfc_main$9;
      const _component_UButton = _sfc_main$B;
      _push(ssrRenderComponent(_component_FullScreenModal, mergeProps({
        modelValue: isOpen.value,
