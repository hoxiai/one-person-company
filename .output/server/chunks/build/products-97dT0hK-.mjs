import { e as useI18n, C as useRoute, r as useRouter, g as useToast, s as useConfirm, h as useAdminPermissions, I as useCurrencyFormat, t as useSettings, x as usePagination, y as useFetch, b as _sfc_main$E, d as _sfc_main$i, o as _sfc_main$h, k as _sfc_main$z, l as _sfc_main$f, n as _sfc_main$v, z as _sfc_main$l, c as _sfc_main$j, N as _sfc_main$e, p as _sfc_main$q } from './server.mjs';
import { _ as _sfc_main$7 } from './Tooltip-C7KhY2S3.mjs';
import { _ as __nuxt_component_7 } from './FullScreenModal-C_oQJW_c.mjs';
import { _ as _sfc_main$8 } from './Checkbox-CxcXUR8O.mjs';
...
import { p as parseMetaPresets, a as PRODUCT_META_PRESETS_KEY, b as presetFieldsForType, s as stripUiIds, d as cleanServiceSchemaFields, e as cleanProductFeatures, f as parseProductFeatures, g as parseServiceSchemaFields } from './adminProductFormData-BiTP6ur1.mjs';
import { useSortable } from '@vueuse/integrations/useSortable';
import { A as AdminCardsPanel } from './AdminCardsPanel-DaUqdZoL.mjs';
              ...
              if (__props.images && __props.images.length > 0) {
                _push2(ssrRenderComponent(unref(draggable), {
                  ...
                  item: withCtx(({ element, index }, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="relative w-32 h-32 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800 group cursor-move"${_scopeId2}><img${ssrRenderAttr("src", element)} class="w-full h-full object-cover"${_scopeId2}><div class="absolute inset-0 bg-gray-900/50 dark:bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2"${_scopeId2}>`);
...
const useAdminProductForm = (emit) => {
  ...
  const metaPresets = computed(() => {
    var _a;
    return parseMetaPresets((_a = settings.value) == null ? void 0 : _a[PRODUCT_META_PRESETS_KEY]);
  });
      ...
      _push(ssrRenderComponent(_component_UModal, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<img${ssrRenderAttr("src", previewImageUrl.value)} class="max-w-full max-h-[85vh] object-contain rounded"${_scopeId}></div>`);
          } else {
            return [
          ...
          "image-cell": withCtx(({ row }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (row.original.imageUrl) {
                _push2(`<img${ssrRenderAttr("src", String(row.original.imageUrl))} class="w-full h-full object-cover"${ssrRenderAttr("alt", String(row.original.name))}${_scopeId}>`);
              } else {
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: "ph:image",
