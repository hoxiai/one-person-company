import { f as useI18n, D as useRoute, s as useRouter, h as useToast, t as useConfirm, i as useAdminPermissions, J as useCurrencyFormat, v as useSettings, y as usePagination, z as useFetch, b as _sfc_main$G, d as _sfc_main$k, p as _sfc_main$j, l as _sfc_main$B, n as _sfc_main$h, o as _sfc_main$x, B as _sfc_main$n, c as _sfc_main$l, e as _sfc_main$g, q as _sfc_main$s } from './server.mjs';
import { _ as _sfc_main$7 } from './Tooltip-BUkNJ5vn.mjs';
import { _ as __nuxt_component_7 } from './FullScreenModal-D08055Gv.mjs';
import { _ as _sfc_main$8 } from './Checkbox-BmTSvkxP.mjs';
import __nuxt_component_9 from './RichEditor-R-T5BS1y.mjs';
...
import { A as AdminCardsPanel } from './AdminCardsPanel-1iIxBJIR.mjs';
import { A as AdminSubscriptionsPanel } from './AdminSubscriptionsPanel-Buao5o_E.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UCheckbox = _sfc_main$8;
      const _component_UTextarea = _sfc_main$g;
      const _component_RichEditor = __nuxt_component_9;
      ...
      _push(ssrRenderComponent(_component_FullScreenModal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_UFormField, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<p class="text-xs text-gray-500 mt-1"${_scopeId2}>${ssrInterpolate(_ctx.$t("admin.products.form.original_price.help"))}</p>`);
                  } else {
                    return [
                      createVNode(_component_UInput, {
                        modelValue: unref(form).metaData.original_price,
            ...
            if (unref(currentTabLocale) === unref(defaultLocale)) {
              _push2(`<div class="p-4 border border-gray-200 dark:border-gray-800 rounded-lg bg-gray-50 dark:bg-[#1a1a1c]"${_scopeId}><div class="flex items-center justify-between mb-3"${_scopeId}><div class="flex items-center gap-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "ph:tag-duotone",
                class: "w-5 h-5 text-purple-500"
              }, null, _parent2, _scopeId));
              _push2(`<h3 class="text-gray-900 dark:text-white font-medium text-sm"${_scopeId}>${ssrInterpolate(_ctx.$t("admin.products.form.discounts_title"))}</h3></div>`);
              _push2(ssrRenderComponent(_component_UButton, {
                color: "primary",
                variant: "ghost",
                size: "xs",
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(_ctx.$t("admin.products.form.volume_discounts.add"))}`);
                  } else {
                    return [
              ...
              if ((_b = (_a = unref(form).metaData) == null ? void 0 : _a.volume_discounts) == null ? void 0 : _b.length) {
                ...
                ssrRenderList(unref(form).metaData.volume_discounts, (tier, idx) => {
                  _push2(`<div class="flex items-center gap-3 p-2.5 rounded-lg bg-white dark:bg-black/30 border border-gray-200 dark:border-white/5"${_scopeId}><div class="flex-1 grid grid-cols-2 gap-3"${_scopeId}><div${_scopeId}><label class="block text-[11px] text-gray-500 mb-1"${_scopeId}>${ssrInterpolate(_ctx.$t("admin.products.form.volume_discounts.min_quantity"))}</label>`);
                  _push2(ssrRenderComponent(_component_UInput, {
                  ...
                  _push2(`</div><div${_scopeId}><label class="block text-[11px] text-gray-500 mb-1"${_scopeId}>${ssrInterpolate(_ctx.$t("admin.products.form.volume_discounts.discount_rate"))}</label>`);
                  _push2(ssrRenderComponent(_component_UInput, {
                  ...
                  _push2(`</div></div><div class="flex items-center pt-5"${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_UButton, {
                    color: "error",
                    variant: "ghost",
                    size: "xs",
                ...
                _push2(`<p class="text-xs text-gray-400 dark:text-gray-500 italic"${_scopeId}>${ssrInterpolate(_ctx.$t("admin.products.form.volume_discounts.tip"))}</p>`);
              }
              _push2(`<div class="pt-3 border-t border-gray-200 dark:border-white/5"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UFormField, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<p class="text-xs text-gray-500 mt-1"${_scopeId2}>${ssrInterpolate(_ctx.$t("admin.products.form.promo_discount.help"))}</p>`);
                  } else {
                    return [
                      createVNode(_component_UInput, {
                        modelValue: unref(form).metaData.promo_discount_rate,
            ...
            return [
              ...
              createVNode("form", {
                ...
                unref(currentTabLocale) === unref(defaultLocale) ? (openBlock(), createBlock("div", {
                  key: 2,
                  class: "p-4 border border-gray-200 dark:border-gray-800 rounded-lg bg-gray-50 dark:bg-[#1a1a1c]"
                }, [
                  createVNode("div", { class: "flex items-center justify-between mb-3" }, [
                    createVNode("div", { class: "flex items-center gap-2" }, [
                      ...
                      createVNode("h3", { class: "text-gray-900 dark:text-white font-medium text-sm" }, toDisplayString(_ctx.$t("admin.products.form.discounts_title")), 1)
                    ]),
                    createVNode(_component_UButton, {
                      color: "primary",
                      variant: "ghost",
                  ...
                  createVNode("div", { class: "space-y-3" }, [
                    ((_d = (_c = unref(form).metaData) == null ? void 0 : _c.volume_discounts) == null ? void 0 : _d.length) ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "space-y-2"
                    }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(form).metaData.volume_discounts, (tier, idx) => {
                        return openBlock(), createBlock("div", {
                          key: idx,
                          class: "flex items-center gap-3 p-2.5 rounded-lg bg-white dark:bg-black/30 border border-gray-200 dark:border-white/5"
                        }, [
                          createVNode("div", { class: "flex-1 grid grid-cols-2 gap-3" }, [
                            createVNode("div", null, [
                              createVNode("label", { class: "block text-[11px] text-gray-500 mb-1" }, toDisplayString(_ctx.$t("admin.products.form.volume_discounts.min_quantity")), 1),
                              createVNode(_component_UInput, {
                                modelValue: tier.minQuantity,
                                "onUpdate:modelValue": ($event) => tier.minQuantity = $event,
                                modelModifiers: { number: true },
                            ...
                            createVNode("div", null, [
                              createVNode("label", { class: "block text-[11px] text-gray-500 mb-1" }, toDisplayString(_ctx.$t("admin.products.form.volume_discounts.discount_rate")), 1),
                              createVNode(_component_UInput, {
                                modelValue: tier.discountRate,
                                "onUpdate:modelValue": ($event) => tier.discountRate = $event,
                                modelModifiers: { number: true },
                          ...
                          createVNode("div", { class: "flex items-center pt-5" }, [
                            createVNode(_component_UButton, {
                              color: "error",
                              variant: "ghost",
                              size: "xs",
                    ...
                    }, toDisplayString(_ctx.$t("admin.products.form.volume_discounts.tip")), 1)),
                    createVNode("div", { class: "pt-3 border-t border-gray-200 dark:border-white/5" }, [
                      createVNode(_component_UFormField, {
                        label: _ctx.$t("admin.products.form.promo_discount.label")
                      }, {
                        default: withCtx(() => [
