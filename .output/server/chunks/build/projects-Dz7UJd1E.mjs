...
import { e as useI18n, aL as useLocaleRouter, g as useToast, bi as useSeoMeta, b as _sfc_main$E, a as __nuxt_component_3$1, p as _sfc_main$q, k as _sfc_main$z, N as _sfc_main$e, d as _sfc_main$i } from './server.mjs';
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "py-10 md:py-16" }, [
                ...
                createVNode("div", { class: "flex items-center justify-center mb-10" }, [
                  createVNode("div", { class: "inline-flex flex-wrap items-center justify-center gap-1.5 p-1.5 rounded-2xl bg-slate-100 border border-slate-200/60 shadow-2xs" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(categories), (cat) => {
                      return openBlock(), createBlock("button", {
                        key: cat.id,
                        type: "button",
                        class: ["inline-flex items-center gap-1.5 rounded-xl px-3.5 py-1.5 text-xs font-medium transition-all cursor-pointer", activeCategory.value === cat.id ? "bg-white text-slate-900 shadow-xs font-semibold" : "text-slate-600 hover:text-slate-900"],
                ...
                filteredProjects.value.length > 0 ? (openBlock(), createBlock("div", {
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(filteredProjects.value, (project) => {
                    return openBlock(), createBlock("div", {
                      key: project.id,
                      class: "flex flex-col justify-between rounded-2xl border border-slate-200/80 bg-white p-5 md:p-6 transition-all duration-200 hover:border-blue-400/60 hover:shadow-md hover:-translate-y-0.5"
                    }, [
                      createVNode("div", null, [
