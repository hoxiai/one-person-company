...
import { e as useI18n, aM as useLocaleRouter, u as useHead, y as useFetch, a as __nuxt_component_3$1, b as _sfc_main$G } from './server.mjs';
...
import { u as useHoxiModels, s as sortModels, a as formatPrice } from './useHoxiModels-DpcwauH-.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const featuredModels = computed(() => sortModels(models.value, "valueIndex", "desc").slice(0, 4));
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span${_scopeId2}>\u4E2D\u8F6C\u7AD9</span>`);
            ...
            _push2(`</div></div></div></section><section class="mt-14 md:mt-20"${_scopeId}><div class="flex flex-col sm:flex-row sm:items-end justify-between gap-3 pb-4 border-b border-slate-100 dark:border-slate-800"${_scopeId}><div${_scopeId}><div class="flex items-center gap-2"${_scopeId}><span class="flex h-7 w-7 items-center justify-center rounded-lg bg-amber-500/10 text-amber-600 dark:bg-amber-500/20 dark:text-amber-400 text-sm"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "ph:trophy-bold",
              class: "w-4 h-4"
            }, null, _parent2, _scopeId));
            _push2(`</span><h2 class="text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.savings.modelsSectionTitle"))}</h2></div><p class="mt-1 text-xs text-slate-500 dark:text-slate-400"${_scopeId}>${ssrInterpolate(_ctx.$t("hoxi.savings.modelsSectionNote"))}</p></div>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              to: unref(localePath)("/models"),
            ...
            ssrRenderList(featuredModels.value, (m) => {
              ...
              _push2(`</div><p class="text-xs text-slate-500 dark:text-slate-400 line-clamp-2 leading-relaxed"${_scopeId}>${ssrInterpolate(m.description)}</p></div><div class="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-end justify-between"${_scopeId}><div${_scopeId}><span class="block text-[10px] text-slate-400 dark:text-slate-500"${_scopeId}>\u6DF7\u5408\u4EF7</span><span class="text-sm font-bold text-slate-800 dark:text-slate-200 tabular-nums"${_scopeId}> \xA5${ssrInterpolate(unref(formatPrice)(m.blendedPrice))} <span class="text-[10px] font-normal text-slate-400 dark:text-slate-500"${_scopeId}>/ M</span></span></div><div class="text-right"${_scopeId}><span class="block text-[10px] text-slate-400 dark:text-slate-500"${_scopeId}>\u7EFC\u5408\u5206</span><span class="text-xs font-semibold text-amber-600 dark:text-amber-400 tabular-nums"${_scopeId}>${ssrInterpolate((_a = m.scores.overall) != null ? _a : "\u2014")}</span></div></div></div>`);
            });
            ...
            _push2(`<!--]--></div></section><section class="mt-14 md:mt-20"${_scopeId}><div class="pb-4 border-b border-slate-100 dark:border-slate-800"${_scopeId}><div class="flex items-center gap-2"${_scopeId}><span class="flex h-7 w-7 items-center justify-center rounded-lg bg-indigo-500/10 text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-400 text-sm"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "ph:wrench-bold",
              class: "w-4 h-4"
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</span><span class="text-xs text-blue-600 dark:text-blue-400 font-medium group-hover:translate-x-0.5 transition-transform flex items-center gap-1"${_scopeId2}><span${_scopeId2}>\u770B\u770B</span>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "ph:arrow-right",
                    class: "w-3.5 h-3.5"
                  }, null, _parent3, _scopeId2));
                  _push3(`</span></div><h3 class="text-base font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors"${_scopeId2}> \u6211\u5728\u505A\u7684\u9879\u76EE </h3><p class="mt-2 text-xs md:text-sm text-slate-600 dark:text-slate-400 leading-relaxed"${_scopeId2}> \u6BCF\u4E2A\u9879\u76EE\u505A\u4EC0\u4E48\u3001\u7528\u4EC0\u4E48\u6280\u672F\u6808\u3002 </p>`);
                } else {
                  return [
                    ...
                    createVNode("h3", { class: "text-base font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" }, " \u6211\u5728\u505A\u7684\u9879\u76EE "),
                    createVNode("p", { class: "mt-2 text-xs md:text-sm text-slate-600 dark:text-slate-400 leading-relaxed" }, " \u6BCF\u4E2A\u9879\u76EE\u505A\u4EC0\u4E48\u3001\u7528\u4EC0\u4E48\u6280\u672F\u6808\u3002 ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</span><span class="text-xs text-amber-600 dark:text-amber-400 font-medium group-hover:translate-x-0.5 transition-transform flex items-center gap-1"${_scopeId2}><span${_scopeId2}>\u770B\u770B</span>`);
                  _push3(ssrRenderComponent(_component_UIcon, {
                    name: "ph:arrow-right",
                    class: "w-3.5 h-3.5"
                  }, null, _parent3, _scopeId2));
                  _push3(`</span></div><h3 class="text-base font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors"${_scopeId2}> \u5DE5\u5177\u7BB1 </h3><p class="mt-2 text-xs md:text-sm text-slate-600 dark:text-slate-400 leading-relaxed"${_scopeId2}> \u505A\u72EC\u7ACB\u4EA7\u54C1\u5E38\u7528\u7684\u5F00\u53D1\u3001\u90E8\u7F72\u3001\u6536\u6B3E\u548C AI \u5DE5\u5177\u3002 </p>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center justify-between mb-3" }, [
                    ...
                    createVNode("h3", { class: "text-base font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors" }, " \u5DE5\u5177\u7BB1 "),
                    createVNode("p", { class: "mt-2 text-xs md:text-sm text-slate-600 dark:text-slate-400 leading-relaxed" }, " \u505A\u72EC\u7ACB\u4EA7\u54C1\u5E38\u7528\u7684\u5F00\u53D1\u3001\u90E8\u7F72\u3001\u6536\u6B3E\u548C AI \u5DE5\u5177\u3002 ")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "py-8 md:py-16" }, [
                createVNode("div", { class: "text-center max-w-3xl mx-auto mb-10 md:mb-14" }, [
                  ...
                  createVNode("p", { class: "mt-4 text-base md:text-lg text-slate-600 dark:text-slate-400 leading-relaxed" }, toDisplayString(_ctx.$t("hoxi.savings.subtitle")), 1)
                ]),
                createVNode("section", { class: "mt-8 rounded-2xl border border-amber-200/70 dark:border-amber-900/60 bg-gradient-to-br from-amber-50/50 via-white to-amber-50/20 dark:from-amber-950/20 dark:via-slate-900 dark:to-slate-900/80 p-4 sm:p-6 md:p-8 shadow-2xs" }, [
                  ...
                  createVNode("div", { class: "mt-6 grid gap-4 md:grid-cols-3" }, [
                    createVNode("div", { class: "rounded-xl border border-slate-200/70 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 p-4 flex flex-col justify-between" }, [
                      ...
                      createVNode("div", { class: "mt-4 pt-3 border-t border-slate-100 dark:border-slate-800/80 flex items-center justify-between" }, [
                        createVNode("span", { class: "text-[11px] text-slate-400 dark:text-slate-500" }, "\u63A8\u8350\u65B9\u6848"),
                  ...
                  createVNode("div", { class: "flex flex-col sm:flex-row sm:items-end justify-between gap-3 pb-4 border-b border-slate-100 dark:border-slate-800" }, [
                    createVNode("div", null, [
                      createVNode("div", { class: "flex items-center gap-2" }, [
                        createVNode("span", { class: "flex h-7 w-7 items-center justify-center rounded-lg bg-amber-500/10 text-amber-600 dark:bg-amber-500/20 dark:text-amber-400 text-sm" }, [
                          createVNode(_component_UIcon, {
                            name: "ph:trophy-bold",
                            class: "w-4 h-4"
                          })
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(featuredModels.value, (m) => {
                      ...
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-end justify-between" }, [
                          createVNode("div", null, [
                            createVNode("span", { class: "block text-[10px] text-slate-400 dark:text-slate-500" }, "\u6DF7\u5408\u4EF7"),
                            createVNode("span", { class: "text-sm font-bold text-slate-800 dark:text-slate-200 tabular-nums" }, [
                              ...
                              createVNode("span", { class: "text-[10px] font-normal text-slate-400 dark:text-slate-500" }, "/ M")
                            ])
                          ]),
                          createVNode("div", { class: "text-right" }, [
                            createVNode("span", { class: "block text-[10px] text-slate-400 dark:text-slate-500" }, "\u7EFC\u5408\u5206"),
                            createVNode("span", { class: "text-xs font-semibold text-amber-600 dark:text-amber-400 tabular-nums" }, toDisplayString((_a = m.scores.overall) != null ? _a : "\u2014"), 1)
                          ])
                        ])
                      ]);
                    }), 128))
                ...
                createVNode("section", { class: "mt-14 md:mt-20" }, [
                  createVNode("div", { class: "pb-4 border-b border-slate-100 dark:border-slate-800" }, [
                    createVNode("div", { class: "flex items-center gap-2" }, [
                      createVNode("span", { class: "flex h-7 w-7 items-center justify-center rounded-lg bg-indigo-500/10 text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-400 text-sm" }, [
                        createVNode(_component_UIcon, {
                          name: "ph:wrench-bold",
                          class: "w-4 h-4"
                        })
