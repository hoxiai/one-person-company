...
const styles = {
  "themes/hoxi/components/HoxiCommunityModal.vue": () => import('./HoxiCommunityModal-styles.Bw7m8cHa.mjs').then(interopDefault),
  "themes/hoxi/components/HoxiCommunityModal.vue?vue&type=style&index=0&scoped=2025157f&lang.css": () => import('./HoxiCommunityModal-styles.Bw7m8cHa.mjs').then(interopDefault),
  ...
  "themes/hoxi/pages/blog/[slug].vue": () => import('./_slug_-styles.C1HA4p0K.mjs').then(interopDefault),
  "themes/hoxi/pages/blog/[slug].vue?vue&type=style&index=0&lang.css": () => import('./_slug_-styles.C1HA4p0K.mjs').then(interopDefault),
  ...
  "components/AdminSidebar.vue": () => import('./AdminSidebar-styles.B428_HDR.mjs').then(interopDefault),
  "components/PaymentWorkspace.vue": () => import('./PaymentWorkspace-styles.DU6RuDiV.mjs').then(interopDefault),
  "components/AdminSidebar.vue?vue&type=style&index=0&scoped=5f2fea6c&lang.css": () => import('./AdminSidebar-styles.B428_HDR.mjs').then(interopDefault),
