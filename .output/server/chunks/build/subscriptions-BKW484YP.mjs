import { f as useI18n, a as __nuxt_component_3$1, b as _sfc_main$G } from './server.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/subscriptions.vue");
