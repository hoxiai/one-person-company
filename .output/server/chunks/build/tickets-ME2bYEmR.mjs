import { n as _sfc_main$v, k as _sfc_main$z, b as _sfc_main$E, d as _sfc_main$i, o as _sfc_main$h, p as _sfc_main$q, N as _sfc_main$e } from './server.mjs';
import { defineComponent, ref, computed, mergeProps, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createVNode, Fragment, renderList, createCommentVNode, useSSRContext } from 'vue';
              ...
              ssrRenderList(detailMessages.value, (msg) => {
                ...
                if (msg.attachments && msg.attachments.length > 0) {
                  ...
                  ssrRenderList(msg.attachments, (att, aIdx) => {
                    _push2(`<div class="w-16 h-16 rounded-xl border border-gray-200 dark:border-white/10 overflow-hidden cursor-pointer hover:scale-105 transition-transform bg-white/40 dark:bg-black/20"${_scopeId}><img${ssrRenderAttr("src", att.url)}${ssrRenderAttr("alt", att.name || "\u9644\u4EF6")} class="w-full h-full object-cover"${_scopeId}></div>`);
                  });
                  _push2(`<!--]--></div>`);
                } else {
                  _push2(`<!---->`);
