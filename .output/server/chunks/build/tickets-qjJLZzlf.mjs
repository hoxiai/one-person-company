import { h as useToast, o as _sfc_main$x, l as _sfc_main$B, b as _sfc_main$G, d as _sfc_main$k, p as _sfc_main$j, q as _sfc_main$s, e as _sfc_main$g } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const detailWalletBackend = ref("local");
    ...
    const compensationRequest = ref(null);
    const toast = useToast();
    const newIdempotencyKey = () => {
      if (typeof crypto.randomUUID === "function") return crypto.randomUUID();
      return Array.from(crypto.getRandomValues(new Uint8Array(16)), (byte) => byte.toString(16).padStart(2, "0")).join("");
    };
    const compensationTypeItems = computed(() => [
      { label: "\u7B97\u529B\u70B9\u6570 / \u8D60\u9001\u989D\u5EA6 (Grant)", value: "grant", disabled: detailWalletBackend.value === "ainode" },
      { label: "\u73B0\u91D1\u4F59\u989D (Cash)", value: "cash" }
    ]);
    const openCompensation = () => {
      var _a, _b;
      const ticketId = Number(((_a = detailTicket.value) == null ? void 0 : _a.id) || 0);
      if (!ticketId) return;
      if (detailWalletBackend.value === "ainode") compensationType.value = "cash";
      if (((_b = compensationRequest.value) == null ? void 0 : _b.ticketId) !== ticketId) {
        compensationRequest.value = { ticketId, key: newIdempotencyKey() };
      }
    ...
    const openTicketDetail = async (id) => {
      ...
      try {
        ...
        if ((res == null ? void 0 : res.code) === 200) {
          ...
          detailWalletBackend.value = ((_d = res.data) == null ? void 0 : _d.walletBackend) === "ainode" ? "ainode" : "local";
          detailRecentOrders.value = ((_e = res.data) == null ? void 0 : _e.recentOrders) || [];
          quickStatusChange.value = ((_f = detailTicket.value) == null ? void 0 : _f.status) || "open";
          quickPriorityChange.value = ((_g = detailTicket.value) == null ? void 0 : _g.priority) || "normal";
        }
      } catch (e) {
    ...
    const submitCompensation = async () => {
      var _a, _b, _c, _d;
      if (!detailTicket.value || compensationAmount.value <= 0 || compensationSubmitting.value) return;
      const ticketId = Number(detailTicket.value.id);
      if (((_a = compensationRequest.value) == null ? void 0 : _a.ticketId) !== ticketId) {
        compensationRequest.value = { ticketId, key: newIdempotencyKey() };
      }
      const idempotencyKey = compensationRequest.value.key;
      compensationSubmitting.value = true;
      try {
        const res = await $fetch(`/api/admin/tickets/${ticketId}/compensation`, {
          method: "POST",
          body: {
        ...
        if ((res == null ? void 0 : res.code) === 200) {
          compensationRequest.value = null;
          compensationModalOpen.value = false;
          if ((_b = res == null ? void 0 : res.data) == null ? void 0 : _b.duplicate) {
            toast.add({ title: "\u8BE5\u8865\u507F\u5DF2\u53D1\u653E\u8FC7", description: "\u672C\u6B21\u672A\u91CD\u590D\u5165\u8D26", color: "warning" });
          }
        ...
        toast.add({
          title: "\u8865\u507F\u53D1\u653E\u5931\u8D25",
          description: `${((_c = e == null ? void 0 : e.data) == null ? void 0 : _c.statusMessage) || ((_d = e == null ? void 0 : e.data) == null ? void 0 : _d.message) || (e == null ? void 0 : e.message) || "\u8BF7\u7A0D\u540E\u91CD\u8BD5"}\uFF08\u91CD\u8BD5\u4E0D\u4F1A\u91CD\u590D\u53D1\u653E\uFF09`,
          color: "error"
        });
      } finally {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_USelect, {
              ...
              items: compensationTypeItems.value,
              class: "w-full"
            }, null, _parent2, _scopeId));
            if (detailWalletBackend.value === "ainode") {
              _push2(`<p class="mt-1 text-xs text-gray-500 dark:text-gray-400"${_scopeId}> \u672C\u7AD9\u94B1\u5305\u7531 AINode \u7BA1\u7406\uFF0C\u8D60\u9001\u989D\u5EA6\u4F1A\u5728\u7528\u6237\u8BA2\u9605\u6362\u671F\u65F6\u6E05\u7A7A\uFF0C\u8865\u507F\u53EA\u53D1\u653E\u73B0\u91D1\u4F59\u989D\u3002 </p>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", { class: "p-6 sm:p-7 space-y-5" }, [
                ...
                createVNode("div", null, [
                  ...
                  detailWalletBackend.value === "ainode" ? (openBlock(), createBlock("p", {
                    key: 0,
                    class: "mt-1 text-xs text-gray-500 dark:text-gray-400"
                  }, " \u672C\u7AD9\u94B1\u5305\u7531 AINode \u7BA1\u7406\uFF0C\u8D60\u9001\u989D\u5EA6\u4F1A\u5728\u7528\u6237\u8BA2\u9605\u6362\u671F\u65F6\u6E05\u7A7A\uFF0C\u8865\u507F\u53EA\u53D1\u653E\u73B0\u91D1\u4F59\u989D\u3002 ")) : createCommentVNode("", true)
                ]),
                createVNode("div", null, [
                  createVNode("label", { class: "block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1" }, [
