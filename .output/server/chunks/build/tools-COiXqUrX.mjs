...
import { g as useToast, d as _sfc_main$k, o as _sfc_main$j, b as _sfc_main$G, n as _sfc_main$x, k as _sfc_main$B, p as _sfc_main$s, c as _sfc_main$l, O as _sfc_main$g } from './server.mjs';
      ...
      _push(ssrRenderComponent(_component_UModal, {
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`</div><div class="space-y-1.5 text-xs text-gray-600 dark:text-gray-300"${_scopeId}><p class="text-sm font-semibold text-gray-900 dark:text-white"${_scopeId}> \u786E\u5B9A\u8981\u5220\u9664\u8BE5\u5DE5\u5177\u5417\uFF1F </p><p${_scopeId}> \u5373\u5C06\u5220\u9664\u5DE5\u5177 <span class="font-semibold text-gray-900 dark:text-white font-mono"${_scopeId}>\u201C${ssrInterpolate((_a2 = itemToDelete.value) == null ? void 0 : _a2.name)}\u201D</span>\uFF08${ssrInterpolate((_b = itemToDelete.value) == null ? void 0 : _b.id)}\uFF09\u3002 </p><p class="text-red-500 dark:text-red-400"${_scopeId}> \u6B64\u64CD\u4F5C\u5C06\u76F4\u63A5\u4ECE \`hoxi_tools\` \u6570\u636E\u5E93\u4E2D\u6C38\u4E45\u79FB\u9664\uFF0C\u4E0D\u53EF\u64A4\u9500\u3002 </p></div></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-start gap-3 py-2" }, [
                ...
                createVNode("div", { class: "space-y-1.5 text-xs text-gray-600 dark:text-gray-300" }, [
                  createVNode("p", { class: "text-sm font-semibold text-gray-900 dark:text-white" }, " \u786E\u5B9A\u8981\u5220\u9664\u8BE5\u5DE5\u5177\u5417\uFF1F "),
                  createVNode("p", null, [
                    createTextVNode(" \u5373\u5C06\u5220\u9664\u5DE5\u5177 "),
                  ...
                  createVNode("p", { class: "text-red-500 dark:text-red-400" }, " \u6B64\u64CD\u4F5C\u5C06\u76F4\u63A5\u4ECE `hoxi_tools` \u6570\u636E\u5E93\u4E2D\u6C38\u4E45\u79FB\u9664\uFF0C\u4E0D\u53EF\u64A4\u9500\u3002 ")
                ])
              ])
            ];
          }
