...
import { e as useI18n, aL as useLocaleRouter, bi as useSeoMeta, b as _sfc_main$E, a as __nuxt_component_3$1 } from './server.mjs';
      ...
      _push(ssrRenderComponent(_component_HoxiContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="flex items-center justify-center mb-10"${_scopeId}><div class="inline-flex flex-wrap items-center justify-center gap-1.5 p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-2xs"${_scopeId}><!--[-->`);
            ssrRenderList(unref(categories), (cat) => {
              _push2(`<button type="button" class="${ssrRenderClass([activeCategory.value === cat.id ? "bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-xs font-semibold" : "text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white", "inline-flex items-center gap-1.5 rounded-xl px-3.5 py-1.5 text-xs font-medium transition-all"])}"${_scopeId}>`);
              if (cat.icon) {
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: cat.icon,
                  class: "w-3.5 h-3.5"
            ...
            return [
              createVNode("div", { class: "py-10 md:py-16" }, [
                ...
                createVNode("div", { class: "flex items-center justify-center mb-10" }, [
                  createVNode("div", { class: "inline-flex flex-wrap items-center justify-center gap-1.5 p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-2xs" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(categories), (cat) => {
                      return openBlock(), createBlock("button", {
                        key: cat.id,
                        type: "button",
                        class: ["inline-flex items-center gap-1.5 rounded-xl px-3.5 py-1.5 text-xs font-medium transition-all", activeCategory.value === cat.id ? "bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-xs font-semibold" : "text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"],
                ...
                filteredTools.value.length > 0 ? (openBlock(), createBlock("div", {
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(filteredTools.value, (tool) => {
                    return openBlock(), createBlock("div", {
                      key: tool.id,
                      class: "flex flex-col justify-between rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900/70 p-5 md:p-6 transition-all duration-200 hover:border-amber-400/60 dark:hover:border-amber-500/50 hover:shadow-lg dark:hover:bg-slate-900 hover:-translate-y-0.5"
                    }, [
                      createVNode("div", null, [
