import { d as defineEventHandler, c as getRequestLocale, bQ as requireUserSession, e as createError, cA as listUserPromoInviteRelations } from '../../../../nitro/nitro.mjs';
import 'drizzle-orm';
import 'node:crypto';
import 'crypto';
import 'fs';
